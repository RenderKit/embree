      ...
      inline void patch_eval_subdivision (const HalfEdge* h, Tessellator tessellator)
    {
      ...
      else
      {
        for (unsigned i=0; i<N; i++) 
        {
          ...
          const Vec2f uv[4] = { (1.0f/4.0f) * (base + 0.5f*(0.5f+Vec2f(0.0f,0.0f))),
                                (1.0f/4.0f) * (base + 0.5f*(0.5f+Vec2f(1.0f,0.0f))),
                                (1.0f/4.0f) * (base + 0.5f*(0.5f+Vec2f(1.0f,1.0f))),
                                (1.0f/4.0f) * (base + 0.5f*(0.5f+Vec2f(0.0f,1.0f))) };
