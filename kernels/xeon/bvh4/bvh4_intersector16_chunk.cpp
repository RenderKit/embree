...
namespace embree
{
  namespace isa
  {
    ...
    void BVH4Intersector16Chunk<types, robust, PrimitiveIntersector16>::intersect(bool16* valid_i, BVH4* bvh, Ray16& ray)
    {
...
#pragma unroll(4)
	...
	PrimitiveIntersector16::intersect(valid_leaf,pre,ray,prim,items,bvh->scene);
    ...
    template<int types, bool robust, typename PrimitiveIntersector16>
    void BVH4Intersector16Chunk<types, robust, PrimitiveIntersector16>::occluded(bool16* valid_i, BVH4* bvh, Ray16& ray)
    {
      /* verify correct input */
...
#pragma unroll(4)
	...
	assert(cur != BVH4::emptyNode);
        ...
        size_t items; const Primitive* prim = (Primitive*) cur.leaf(items);
        terminated |= valid_leaf & PrimitiveIntersector16::occluded(valid_leaf,pre,ray,prim,items,bvh->scene);
