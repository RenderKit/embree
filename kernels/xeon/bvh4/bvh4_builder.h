...
namespace embree
{
  namespace isa
  {
    ...
    public:
      ...
      /*! build job */
      TASK_RUN_FUNCTION_(BVH4Builder,build_parallel);
      ...
      template<bool PARALLEL>
      static size_t createNode(size_t threadIndex, size_t threadCount, BVH4Builder* parent, BuildRecord& record, BuildRecord records_o[BVH4::N]);
