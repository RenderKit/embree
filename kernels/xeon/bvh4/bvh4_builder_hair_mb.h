...
namespace embree
{
  namespace isa
  {
    class BVH4HairBuilderMB : public Builder
    {
      ALIGNED_CLASS;
    public:
      ...
      /*! Constructor. */
      BVH4HairBuilderMB (BVH4Hair* bvh, Scene* scene, size_t mode);
	...
	void processTask(size_t threadIndex, size_t threadCount, BuildTask& task, BuildTask task_o[BVH4Hair::N], size_t& N);
      ...
      TASK_RUN_FUNCTION(BVH4HairBuilderMB,task_build_parallel);
    ...
    class BVH4HairBuilderMBT : public BVH4HairBuilderMB
    {
    public:
      BVH4HairBuilderMBT (BVH4Hair* bvh, Scene* scene, size_t mode);
