...
namespace embree
{
  ...
  public:
    ...
    struct TransformNode
    {
      ...
      __forceinline TransformNode(const AffineSpace3fa& local2world, const BBox3fa& localBounds, NodeRef child, int instID) 
        : local2world(local2world), world2local(rcp(local2world)), localBounds(localBounds), child(child), instID(instID) {}
