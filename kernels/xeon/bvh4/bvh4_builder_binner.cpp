...
namespace embree
{
  namespace isa
  {
    ...
    template<int BINS>
    void Binner2<BINS>::best(Split2& split, const Mapping2& mapping)
    {
      ssef rAreas[BINS];
      ssei rCounts[BINS];
                                  ...
                                  BuildRecord& right)
    {
      ...
      local_left.centroid.lower = (Vec3fa) left_centroidMinAABB;
      local_left.centroid.upper = (Vec3fa) left_centroidMaxAABB;
      local_left.geometry.lower = (Vec3fa) left_sceneMinAABB;
      local_left.geometry.upper = (Vec3fa) left_sceneMaxAABB;
      
      local_right.centroid.lower = (Vec3fa) right_centroidMinAABB;
      local_right.centroid.upper = (Vec3fa) right_centroidMaxAABB;
