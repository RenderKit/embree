...
namespace embree
{
  namespace isa
  {
    ...
    __forceinline void BVH4Intersector4Hybrid<types,PrimitiveIntersector4>::intersect1(const BVH4* bvh, NodeRef root, const size_t k, Precalculations& pre, 
										       Ray4& ray, const sse3f &ray_org, const sse3f &ray_dir, const sse3f &ray_rdir, const ssef &ray_tnear, const ssef &ray_tfar, const sse3i& nearXYZ)
    {
      /*! stack state */
    ...
    template<int types, typename PrimitiveIntersector4>
    __forceinline bool BVH4Intersector4Hybrid<types,PrimitiveIntersector4>::occluded1(const BVH4* bvh, NodeRef root, const size_t k, Precalculations& pre, 
											     Ray4& ray,const sse3f &ray_org, const sse3f &ray_dir, const sse3f &ray_rdir, const ssef &ray_tnear, const ssef &ray_tfar, const sse3i& nearXYZ)
    {
      /*! stack state */
