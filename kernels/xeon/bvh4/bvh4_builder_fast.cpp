...
namespace embree
{
  namespace isa
  {
    ...
    {
      if (mesh) PrimRefArrayGenFromTriangleMesh::generate_sequential(threadIndex, threadCount, mesh , prims, pinfo);
    ...
    {
      if (mesh) PrimRefArrayGenFromTriangleMesh::generate_parallel(threadIndex, threadCount, mesh , prims, pinfo);
