    ...
    struct Triangle4iIntersector1Pluecker
      {
        ...
        static __forceinline void intersect(const Precalculations& pre, Ray& ray, const RTCIntersectionContext* context, const Primitive& tri, Scene* scene, const unsigned* geomID_to_instID)
        {
          STAT3(normal.trav_prims,1,1,1);
          Vec3vf4 v0, v1, v2; tri.gather(v0,v1,v2);
          pre.intersect(ray,v0,v1,v2,UVIdentity<M>(),Intersect1EpilogM<M,Mx,filter>(ray,context,tri.geomIDs,tri.primIDs,scene,geomID_to_instID)); 
        }
        ...
        static __forceinline bool occluded(const Precalculations& pre, Ray& ray, const RTCIntersectionContext* context, const Primitive& tri, Scene* scene, const unsigned* geomID_to_instID)
        {
          ...
          Vec3vf4 v0, v1, v2; tri.gather(v0,v1,v2);
          return pre.intersect(ray,v0,v1,v2,UVIdentity<M>(),Occluded1EpilogM<M,Mx,filter>(ray,context,tri.geomIDs,tri.primIDs,scene,geomID_to_instID)); 
        }
      };
