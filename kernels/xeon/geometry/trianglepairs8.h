...
public:
  ...
  public:
    ...
    __forceinline TrianglePairs8 (const Vec3vf8& v0, const Vec3vf8& v1, const Vec3vf8& v2, const vint8& geomIDs, const vint8& primIDs)
    ...
    /*! non temporal store */
    __forceinline static void store_nt(TrianglePairs8* dst, const TrianglePairs8& src)
    {
	...
	const size_t geomID = prim.geomID();
      ...
      TrianglePairs8::store_nt(this,TrianglePairs8(v0,v1,v2,vgeomID,vprimID));
    }
