  ...
  struct QuadQuad4x4Intersector1
  {
    ...
    static __forceinline void intersect(const Precalculations& pre, Ray& ray, const Primitive& prim, const void* geom, size_t& lazy_node)
    {
      ...
      while (mask) {
        ...
        const Vec3fa& v10 = (&v00)[1]; //prim.vertices(x+1,y+0);
        const Vec3fa& v20 = (&v00)[2]; //prim.vertices(x+2,y+0);
        const Vec3fa& v01 = prim.vertices(x+0,y+1);
        const Vec3fa& v11 = (&v01)[1]; //prim.vertices(x+1,y+1);
        const Vec3fa& v21 = (&v01)[2]; //prim.vertices(x+2,y+1);
        const Vec3fa& v02 = prim.vertices(x+0,y+2);
        const Vec3fa& v12 = (&v02)[1]; //prim.vertices(x+1,y+2);
        const Vec3fa& v22 = (&v02)[2]; //prim.vertices(x+2,y+2);
