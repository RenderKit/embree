  ...
  namespace isa
  {
    template<bool list>
      struct Triangle4Intersector1MoellerTrumbore
      {
        ...
        typedef typename TriangleNIntersector1Moeller<Triangle4>::Precalculations Precalculations;
        
        static __forceinline void intersect(const Precalculations& pre, Ray& ray, const Primitive& tri, Scene* scene) {
          TriangleNIntersector1Moeller<Triangle4>::intersect(pre,ray,tri,scene);
        }
        
        static __forceinline bool occluded(const Precalculations& pre, Ray& ray, const Primitive& tri, Scene* scene) {
          return TriangleNIntersector1Moeller<Triangle4>::occluded(pre,ray,tri,scene);
        }
      };
  }
}
