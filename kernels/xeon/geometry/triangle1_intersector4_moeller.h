...
namespace embree
{
  ...
  struct Triangle1Intersector4MoellerTrumbore
  {
    ...
    static __forceinline void intersect(const sseb& valid_i, Precalculations& pre, Ray4& ray, const Triangle1& tri, const void* geom)
    {
    ...
    static __forceinline void intersect(const sseb& valid, Precalculations& pre, Ray4& ray, const Triangle1* __restrict__ tri, size_t num, const void* geom)
    {
      while (true) {
    ...
    static __forceinline sseb occluded(const sseb& valid_i, Precalculations& pre, Ray4& ray, const Triangle1& tri, const void* geom)
    {
    ...
    static __forceinline sseb occluded(const sseb& valid, Precalculations& pre, Ray4& ray, const Triangle1* tri, size_t num, void* geom)
    {
      sseb valid0 = valid;
      while (true) {
