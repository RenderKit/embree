...
namespace embree
{
  namespace isa
  {
      ...
      struct QuadMIntersector1Pluecker<4,filter>
    {
      ...
      __forceinline bool intersect(Ray& ray, const RTCIntersectionContext* context, const Vec3vf4& v0, const Vec3vf4& v1, const Vec3vf4& v2, const Vec3vf4& v3, 
                                   const vint4& geomID, const vint4& primID, Scene* scene, const unsigned* geomID_to_instID) const
      {
      ...
      __forceinline bool occluded(Ray& ray, const RTCIntersectionContext* context, const Vec3vf4& v0, const Vec3vf4& v1, const Vec3vf4& v2, const Vec3vf4& v3, 
                                  const vint4& geomID, const vint4& primID, Scene* scene, const unsigned* geomID_to_instID) const
      {
