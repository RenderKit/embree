...
namespace embree
{
  ...
  struct Triangle1vIntersector4Pluecker
  {
    ...
    static __forceinline void intersect(const sseb& valid_i, Precalculations& pre, Ray4& ray, const Triangle1v* __restrict__ tris, size_t num, const void* geom)
    {
    ...
    static __forceinline sseb occluded(const sseb& valid_i, Precalculations& pre, Ray4& ray, const Triangle1v* __restrict__ tris, size_t num, const void* geom)
    {
      sseb valid0 = valid_i;
