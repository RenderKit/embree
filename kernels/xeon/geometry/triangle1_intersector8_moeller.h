...
namespace embree
{
  ...
  struct Triangle1Intersector8MoellerTrumbore
  {
    ...
    static __forceinline void intersect(const avxb& valid_i, Precalculations& pre, Ray8& ray, const Triangle1& tri, const void* geom)
    {
    ...
    static __forceinline void intersect(const avxb& valid, Precalculations& pre, Ray8& ray, const Triangle1* __restrict__ tri, size_t num, const void* geom)
    {
      while (true) {
    ...
    static __forceinline avxb occluded(const avxb& valid_i, Precalculations& pre, Ray8& ray, const Triangle1& tri, const void* geom)
    {
    ...
    static __forceinline avxb occluded(const avxb& valid, Precalculations& pre, Ray8& ray, const Triangle1* tri, size_t num, const void* geom)
    {
      avxb valid0 = valid;
      while (true) {
