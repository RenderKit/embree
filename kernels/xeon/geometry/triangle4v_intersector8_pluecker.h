  ...
  struct Triangle4vIntersector8Pluecker
  {
    ...
    static __forceinline void intersect(const avxb& valid_i, Ray8& ray, const Triangle4v& tri, void* geom)
    {
      for (size_t i=0; i<tri.size(); i++)
      {
        ...
        const avx3f v0 = avx3f(tri.v0.x[i],tri.v0.y[i],tri.v0.z[i])-O;
        const avx3f v1 = avx3f(tri.v1.x[i],tri.v1.y[i],tri.v1.z[i])-O;
        const avx3f v2 = avx3f(tri.v2.x[i],tri.v2.y[i],tri.v2.z[i])-O;
    ...
    static __forceinline avxb occluded(const avxb& valid_i, const Ray8& ray, const Triangle4v& tri, void* geom)
    {
      avxb valid0 = valid_i;
    ...
    static __forceinline avxb occluded(const avxb& valid, const Ray8& ray, const Triangle4v* tri, size_t num, void* geom)
    {
      avxb valid0 = valid;
      for (size_t i=0; i<num; i++) {
