...
#pragma unroll(4)
        ...
        TriangleIntersector4::intersect(valid_leaf,pre,ray,tri,items,bvh->geometry);
...
#pragma unroll(4)
        ...
        size_t items; const Triangle* tri  = (Triangle*) curNode.leaf(accel, items);
        terminated |= TriangleIntersector4::occluded(!terminated,pre,ray,tri,items,bvh->geometry);
    ...
    DEFINE_INTERSECTOR4(BVH4iTriangle4Intersector4ChunkMoeller, BVH4iIntersector4Chunk<Triangle4Intersector4MoellerTrumbore<true> >);
...
#if defined (__AVX__)
    DEFINE_INTERSECTOR4(BVH4iTriangle8Intersector4ChunkMoeller, BVH4iIntersector4Chunk<Triangle8Intersector4MoellerTrumbore<true> >);
#endif
