...
namespace embree
{
  namespace isa 
  {
    ...
    public:
      ...
      static void filterAOS(BVH* bvh, RTCRay* _rayN, const size_t N, const size_t stride, const size_t flags, const bool intersect);
      static void filterSOA(BVH* bvh, RTCRaySOA& _rayN, const size_t N, const size_t streams, const size_t stream_offset, const size_t flags, const bool intersect);
    };
  }
}
