...
extern "C" RTCScene ispcNewScene (RTCFlags flags, RTCAlgorithmFlags aflags) {
  if (!embree::isCoherent(flags) && !embree::isIncoherent(flags)) flags = RTCFlags(flags | RTC_COHERENT);
