...
namespace embree
{
  namespace isa
  {
    ...
    private:
      ...
      static size_t intersectBox(const BVH4Hair::UnalignedNode* node, 
                                 const sse3f& org, const sse3f& dir, 
                                 ssef& tNear, ssef& tFar);

      static void intersect_k(const BVH4Hair* bvh, Ray8& ray, const size_t k);
      static void occluded_k (const BVH4Hair* bvh, Ray8& ray, const size_t k);

    public:
      static void intersect(avxb* valid, const BVH4Hair* bvh, Ray8& ray);
      static void occluded (avxb* valid, const BVH4Hair* bvh, Ray8& ray);
    };
  }
}
