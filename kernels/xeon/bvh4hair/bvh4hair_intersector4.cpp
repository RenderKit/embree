...
#include "bvh4hair_intersector4.h"
...
{ 
  namespace isa
  {
    ...
    __forceinline size_t BVH4HairIntersector4<PrimitiveIntersector>::intersectBox(const BVH4Hair::AlignedNode* node, 
    ...
    template<typename PrimitiveIntersector>
    __forceinline size_t BVH4HairIntersector4<PrimitiveIntersector>::intersectBox(const BVH4Hair::CompressedUnalignedNode* node,
    ...
    template<typename PrimitiveIntersector>
    __forceinline size_t BVH4HairIntersector4<PrimitiveIntersector>::intersectBox(const BVH4Hair::UncompressedUnalignedNode* node,
                                                                                  const sse3f& ray_org, const sse3f& ray_dir, 
                                                                                  ssef& tNear, ssef& tFar)
    {
    ...
    template<typename PrimitiveIntersector>
    __forceinline void BVH4HairIntersector4<PrimitiveIntersector>::intersect_k(const BVH4Hair* bvh, Ray4& ray, const size_t k)
    {
    ...
    template<typename PrimitiveIntersector>
    void BVH4HairIntersector4<PrimitiveIntersector>::intersect(sseb* valid_in, const BVH4Hair* bvh, Ray4& ray)
    {
    ...
    template<typename PrimitiveIntersector>
    void BVH4HairIntersector4<PrimitiveIntersector>::occluded_k(const BVH4Hair* bvh, Ray4& ray, const size_t k) 
    {
      /*! perform per ray precalculations required by the primitive intersector */
      typename PrimitiveIntersector::Precalculations pre(ray,k);
    ...
    template<typename PrimitiveIntersector>
    void BVH4HairIntersector4<PrimitiveIntersector>::occluded(sseb* valid_in, const BVH4Hair* bvh, Ray4& ray)
    {
      int mask = movemask(*valid_in);
      while (mask) occluded_k(bvh,ray,__bscf(mask));
    }

    DEFINE_INTERSECTOR4(BVH4HairBezier1Intersector4,BVH4HairIntersector4<Bezier1Intersector4>);
    DEFINE_INTERSECTOR4(BVH4HairBezier1iIntersector4,BVH4HairIntersector4<Bezier1iIntersector4>);
  }
}
