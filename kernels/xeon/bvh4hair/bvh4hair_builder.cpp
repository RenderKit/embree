...
namespace embree
{
  ...
  const BBox3fa BVH4HairBuilder::subdivideAndAdd(size_t threadIndex, atomic_set<PrimRefBlock>& prims, const Bezier1& bezier, size_t depth)
  {
    if (depth == 0) {
  ...
  void BVH4HairBuilder::insert(size_t threadIndex, atomic_set<PrimRefBlock>& prims_i, atomic_set<PrimRefBlock>& prims_o)
  {
  ...
  void BVH4HairBuilder::split(size_t threadIndex, atomic_set<PrimRefBlock>& prims, const Left& left, 
  ...
  const BBox3fa BVH4HairBuilder::computeAlignedBounds(atomic_set<PrimRefBlock>& prims)
  {
    float area = 0.0f;
    BBox3fa bounds = empty;
  ...
  const NAABBox3fa BVH4HairBuilder::computeAlignedBounds(atomic_set<PrimRefBlock>& prims, const LinearSpace3fa& space)
  {
    float area = 0.0f;
    BBox3fa bounds = empty;
    for (atomic_set<PrimRefBlock>::block_iterator_unsafe i = prims; i; i++)
  ...
  const NAABBox3fa BVH4HairBuilder::computeUnalignedBounds(atomic_set<PrimRefBlock>& prims)
  {
  ...
  __forceinline const BVH4HairBuilder::StrandSplit BVH4HairBuilder::StrandSplit::find(size_t threadIndex, BVH4HairBuilder* parent, atomic_set<PrimRefBlock>& prims)
  {
  ...
  __forceinline void BVH4HairBuilder::StrandSplit::split(size_t threadIndex, BVH4HairBuilder* parent, 
  ...
  __forceinline BVH4HairBuilder::ObjectSplit BVH4HairBuilder::ObjectSplit::find(size_t threadIndex, size_t depth, BVH4HairBuilder* parent, 
  ...
  __forceinline void BVH4HairBuilder::ObjectSplit::split(size_t threadIndex, BVH4HairBuilder* parent, 
                                                          atomic_set<PrimRefBlock>& prims, atomic_set<PrimRefBlock>& lprims_o, atomic_set<PrimRefBlock>& rprims_o) const
  {
    size_t lnum,rnum;
  ...
  const BVH4HairBuilder::SpatialSplit BVH4HairBuilder::SpatialSplit::find(size_t threadIndex, size_t depth, size_t size, BVH4HairBuilder* parent, atomic_set<PrimRefBlock>& prims, const LinearSpace3fa& space)
  {
    /* calculate geometry and centroid bounds */
    BBox3fa geomBounds = empty;
    for (atomic_set<PrimRefBlock>::block_iterator_unsafe i = prims; i; i++)
  ...
  void BVH4HairBuilder::SpatialSplit::split(size_t threadIndex, BVH4HairBuilder* parent, atomic_set<PrimRefBlock>& prims, atomic_set<PrimRefBlock>& lprims_o, atomic_set<PrimRefBlock>& rprims_o) const
  {
  ...
  __forceinline BVH4HairBuilder::FallBackSplit BVH4HairBuilder::FallBackSplit::find(size_t threadIndex, BVH4HairBuilder* parent, atomic_set<PrimRefBlock>& prims, 
  ...
  BVH4Hair::NodeRef BVH4HairBuilder::leaf(size_t threadIndex, size_t depth, atomic_set<PrimRefBlock>& prims, const NAABBox3fa& bounds)
  {
    //size_t N = end-begin;
    size_t N = atomic_set<PrimRefBlock>::block_iterator_unsafe(prims).size();
  ...
  bool BVH4HairBuilder::split(size_t threadIndex, size_t depth, 
  ...
  void BVH4HairBuilder::processTask(size_t threadIndex, BuildTask& task, BuildTask task_o[BVH4Hair::N], size_t& numTasks_o)
  {
  ...
  void BVH4HairBuilder::recurseTask(size_t threadIndex, BuildTask& task)
  {
    size_t numChildren;
