...
namespace embree
{
  namespace isa
  {
    ...
    IF_ENABLED_GRIDS(DEFINE_INTERSECTOR1(BVH4GridIntersector1,BVHNIntersector1<4 COMMA BVH_AN1 COMMA false COMMA ArrayIntersector1<SubGridIntersector1Moeller<false>> >));
    IF_ENABLED_GRIDS(DEFINE_INTERSECTOR1(BVH4GridMBIntersector1,BVHNIntersector1<4 COMMA BVH_AN2_AN4D COMMA false COMMA ArrayIntersector1<SubGridIntersector1Moeller<true>> >));
