...
namespace embree
{
  namespace isa
  {
    ...
    IF_ENABLED_CURVES(DEFINE_INTERSECTOR1(BVH4OBBBezier1iMBIntersector1_OBB,BVHNIntersector1<4 COMMA BVH_AN2_AN4D_UN2 COMMA false COMMA ArrayIntersector1<BezierNiMBIntersector1> >));    
