...
namespace embree
{
  namespace isa
  {
      ...
      class BVHNBuilderHairMBlur
    {
      ...
      typedef HeuristicArrayBinningMB<BezierPrimMB,NUM_OBJECT_BINS> HeuristicBinningMB;
      ...
      typedef UnalignedHeuristicArrayBinningSAH<BezierPrim> UnalignedHeuristicBinningSAH;
