...
namespace embree
{
  namespace isa
  {
    ...
    IF_ENABLED_GRIDS(DEFINE_INTERSECTOR16(BVH8SubGridIntersector16HybridMoellerNoFilter, BVHNIntersectorKHybrid<8 COMMA 16 COMMA BVH_AN1 COMMA false COMMA ArrayIntersectorK_1<16 COMMA SubGridIntersectorKMoeller <16 COMMA false> > >));
