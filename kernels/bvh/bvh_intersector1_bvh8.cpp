...
namespace embree
{
  namespace isa
  {
    ...
    IF_ENABLED_GRIDS(DEFINE_INTERSECTOR1(BVH8GridIntersector1Moeller,BVHNIntersector1<8 COMMA BVH_AN1 COMMA false COMMA QBVHLeafIntersector1<SubGridIntersector1Moeller<false>> >));
    IF_ENABLED_GRIDS(DEFINE_INTERSECTOR1(BVH8GridMBIntersector1Moeller,BVHNIntersector1<8 COMMA BVH_AN2_AN4D COMMA false COMMA QBVHLeafIntersector1<SubGridIntersector1Moeller<true>> >));
