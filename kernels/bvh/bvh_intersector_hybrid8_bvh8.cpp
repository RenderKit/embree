...
namespace embree
{
  namespace isa
  {
    ...
    IF_ENABLED_GRIDS(DEFINE_INTERSECTOR8(BVH8SubGridIntersector8HybridMoellerNoFilter, BVHNIntersectorKHybrid<8 COMMA 8 COMMA BVH_AN1 COMMA false COMMA ArrayIntersectorK_1<8 COMMA SubGridIntersectorKMoeller <8 COMMA false> > >));
