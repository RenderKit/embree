...
namespace embree
{
  ...
  DECLARE_SYMBOL2(Accel::Intersector4,BVH4Triangle4iMBIntersector4SinglePluecker);
  ...
  DECLARE_SYMBOL2(Accel::Intersector4,BVH4Quad4iMBIntersector4SinglePluecker);
  ...
  DECLARE_SYMBOL2(Accel::Intersector8,BVH4Triangle4iMBIntersector8SinglePluecker);
  ...
  DECLARE_SYMBOL2(Accel::Intersector8,BVH4Quad4iMBIntersector8SinglePluecker);
  ...
  DECLARE_SYMBOL2(Accel::Intersector16,BVH4Triangle4iMBIntersector16SinglePluecker);
  ...
  DECLARE_SYMBOL2(Accel::Intersector16,BVH4Quad4iMBIntersector16SinglePluecker);
  ...
  //DECLARE_SYMBOL2(Accel::IntersectorN,BVH4XfmTriangle4IntersectorStreamMoeller);
  ...
  //DECLARE_SYMBOL2(Accel::IntersectorN,BVH4Triangle4vMBIntersectorStreamMoeller);
  ...
  //DECLARE_SYMBOL2(Accel::IntersectorN,BVH4Quad4iMBIntersectorStreamPluecker);
  //DECLARE_SYMBOL2(Accel::IntersectorN,QBVH4Triangle4IntersectorStreamMoeller);
  ...
  BVH4Factory::BVH4Factory (int features)
  {
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_SSE42_AVX_AVX2(features,BVH4Triangle4iMBIntersector4SinglePluecker));
    ...
    IF_ENABLED_QUADS(SELECT_SYMBOL_DEFAULT_AVX     (features,BVH4Quad4iMBIntersector4SinglePluecker));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_INIT_AVX_AVX2(features,BVH4Triangle4iMBIntersector8SinglePluecker));
    ...
    IF_ENABLED_QUADS(SELECT_SYMBOL_INIT_AVX     (features,BVH4Quad4iMBIntersector8SinglePluecker));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_INIT_AVX512KNL_AVX512SKX(features,BVH4Triangle4iMBIntersector16SinglePluecker));
    ...
    IF_ENABLED_QUADS(SELECT_SYMBOL_INIT_AVX512KNL_AVX512SKX(features,BVH4Quad4iMBIntersector16SinglePluecker));
    ...
    //IF_ENABLED_TRIS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Triangle4vMBIntersectorStreamMoeller));
  ...
  Accel::Intersectors BVH4Factory::BVH4Triangle4iMBIntersectors(BVH4* bvh)
  {
    Accel::Intersectors intersectors;
    intersectors.ptr = bvh;
    ...
    */
    intersectors.intersector4  = BVH4Triangle4iMBIntersector4SinglePluecker;
    intersectors.intersector8  = BVH4Triangle4iMBIntersector8SinglePluecker;
    intersectors.intersector16 = BVH4Triangle4iMBIntersector16SinglePluecker;
  ...
  Accel::Intersectors BVH4Factory::BVH4Quad4iMBIntersectors(BVH4* bvh)
  {
    ...
    */
    intersectors.intersector4 = BVH4Quad4iMBIntersector4SinglePluecker;
    intersectors.intersector8 = BVH4Quad4iMBIntersector8SinglePluecker;
    intersectors.intersector16= BVH4Quad4iMBIntersector16SinglePluecker;
  ...
  Accel* BVH4Factory::BVH4Triangle4iMB(Scene* scene)
  {
    BVH4* accel = new BVH4(Triangle4iMB::type,scene);
    Builder* builder = BVH4Triangle4iMBSceneBuilderSAH(accel,scene,0);
    Accel::Intersectors intersectors = BVH4Triangle4iMBIntersectors(accel);
    scene->needTriangleVertices = true;
    return new AccelInstance(accel,builder,intersectors);
  }
  ...
  Accel* BVH4Factory::BVH4Quad4vTwolevel(Scene* scene)
  {
    BVH4* accel = new BVH4(Quad4v::type,scene);
    Accel::Intersectors intersectors = BVH4Quad4vIntersectors(accel);
    Builder* builder = BVH4BuilderTwoLevelQuadMeshSAH(accel,scene,&createQuadMeshQuad4v);
    return new AccelInstance(accel,builder,intersectors);
  }
