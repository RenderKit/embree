...
namespace embree
{
  ...
  DECLARE_SYMBOL2(Accel::Intersector1,BVH4MBTSTriangle4iMBIntersector1Moeller);
  ...
  DECLARE_SYMBOL2(Accel::Intersector4,BVH4MBTSTriangle4iMBIntersector4HybridMoeller);
  ...
  DECLARE_SYMBOL2(Accel::Intersector8,BVH4MBTSTriangle4iMBIntersector8HybridMoeller);
  ...
  DECLARE_SYMBOL2(Accel::Intersector16,BVH4MBTSTriangle4iMBIntersector16HybridMoeller);
  ...
  DECLARE_BUILDER2(void,Scene,size_t,BVH4MB4DTriangle4vMBSceneBuilderInternalTimeSplits);
  ...
  BVH4Factory::BVH4Factory (int features)
  {
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_AVX(features,BVH4MB4DTriangle4iMBSceneBuilderRootTimeSplits));
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_AVX(features,BVH4MB4DTriangle4iMBSceneBuilderInternalTimeSplits));
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_AVX(features,BVH4MB4DTriangle4vMBSceneBuilderInternalTimeSplits));
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_AVX(features,BVH4MBTSTriangle4iMBSceneBuilderSAH));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_SSE42_AVX_AVX2(features,BVH4MBTSTriangle4iMBIntersector1Moeller));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_DEFAULT_SSE42_AVX_AVX2(features,BVH4MBTSTriangle4iMBIntersector4HybridMoeller));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_INIT_AVX_AVX2(features,BVH4MBTSTriangle4iMBIntersector8HybridMoeller));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_INIT_AVX512KNL_AVX512SKX(features,BVH4MBTSTriangle4iMBIntersector16HybridMoeller));
    ...
    IF_ENABLED_LINES(SELECT_SYMBOL_SSE42_AVX_AVX2    (features,BVH4Line4iIntersectorStream));
    //IF_ENABLED_LINES(SELECT_SYMBOL_SSE42_AVX_AVX2      (features,BVH4Line4iMBIntersectorStream));
    IF_ENABLED_HAIR(SELECT_SYMBOL_SSE42_AVX_AVX2      (features,BVH4Bezier1vIntersectorStream));
    IF_ENABLED_HAIR(SELECT_SYMBOL_SSE42_AVX_AVX2      (features,BVH4Bezier1iIntersectorStream));
    ...
    IF_ENABLED_TRIS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Triangle4IntersectorStreamMoeller));
    IF_ENABLED_TRIS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Triangle4IntersectorStreamMoellerNoFilter));
    IF_ENABLED_TRIS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Triangle4iIntersectorStreamMoeller));
    IF_ENABLED_TRIS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Triangle4vIntersectorStreamPluecker));
    IF_ENABLED_TRIS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Triangle4iIntersectorStreamPluecker));
        
    IF_ENABLED_QUADS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Quad4vIntersectorStreamMoeller));
    IF_ENABLED_QUADS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Quad4vIntersectorStreamMoellerNoFilter));
    IF_ENABLED_QUADS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Quad4iIntersectorStreamMoeller));
    IF_ENABLED_QUADS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Quad4vIntersectorStreamPluecker));
    IF_ENABLED_QUADS(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Quad4iIntersectorStreamPluecker));

    //IF_ENABLED_SUBDIV(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4Subdivpatch1CachedIntersectorStream));
    IF_ENABLED_USER(SELECT_SYMBOL_SSE42_AVX_AVX2(features,BVH4VirtualIntersectorStream));
  ...
  Accel::Intersectors BVH4Factory::BVH4MBTSTriangle4iMBIntersectors(BVH4* bvh, IntersectVariant ivariant)
  {
    assert(ivariant == IntersectVariant::FAST);
    Accel::Intersectors intersectors;
    intersectors.ptr = bvh;
    intersectors.intersector1  = BVH4MBTSTriangle4iMBIntersector1Moeller;
    intersectors.intersector4  = BVH4MBTSTriangle4iMBIntersector4HybridMoeller;
    intersectors.intersector8  = BVH4MBTSTriangle4iMBIntersector8HybridMoeller;
    intersectors.intersector16 = BVH4MBTSTriangle4iMBIntersector16HybridMoeller;
    //intersectors.intersectorN  = BVH4MBTSTriangle4iMBIntersectorStreamMoeller;
    return intersectors;
  }
  ...
  Accel* BVH4Factory::BVH4MB4DTriangle4iMB(Scene* scene, BuildVariant bvariant, IntersectVariant ivariant)
  {
    ...
    else  if (scene->device->tri_builder_mb == "root_time_splits"    ) builder = BVH4MB4DTriangle4iMBSceneBuilderRootTimeSplits(accel,scene,0);
    else  if (scene->device->tri_builder_mb == "internal_time_splits") builder = BVH4MB4DTriangle4iMBSceneBuilderInternalTimeSplits(accel,scene,0);
  ...
  Accel* BVH4Factory::BVH4MB4DTriangle4vMB(Scene* scene, BuildVariant bvariant, IntersectVariant ivariant)
  {
    ...
    if (scene->device->tri_builder_mb == "default") {
      switch (bvariant) {
      case BuildVariant::STATIC      : builder = BVH4MB4DTriangle4vMBSceneBuilderInternalTimeSplits(accel,scene,0); break;
      case BuildVariant::DYNAMIC     : assert(false); break; // FIXME: implement
      case BuildVariant::HIGH_QUALITY: assert(false); break;
      }
    }
    else  if (scene->device->tri_builder_mb == "internal_time_splits") builder = BVH4MB4DTriangle4vMBSceneBuilderInternalTimeSplits(accel,scene,0);
    else throw_RTCError(RTC_INVALID_ARGUMENT,"unknown builder "+scene->device->tri_builder_mb+" for BVH4MB4D<Triangle4vMB>");

    return new AccelInstance(accel,builder,intersectors);
  }

  Accel* BVH4Factory::BVH4MBTSTriangle4iMB(Scene* scene, BuildVariant bvariant, IntersectVariant ivariant)
  {
    BVH4* accel = new BVH4(Triangle4iMB::type,scene);

    Accel::Intersectors intersectors;
    if      (scene->device->tri_traverser_mb == "default") intersectors = BVH4MBTSTriangle4iMBIntersectors(accel,ivariant);
    else if (scene->device->tri_traverser_mb == "fast"   ) intersectors = BVH4MBTSTriangle4iMBIntersectors(accel,IntersectVariant::FAST);
    else throw_RTCError(RTC_INVALID_ARGUMENT,"unknown traverser "+scene->device->tri_traverser_mb+" for BVH4MBTS<Triangle4iMB>");

    Builder* builder = nullptr;
    if (scene->device->tri_builder_mb == "default") { // FIXME: implement
      switch (bvariant) {
      case BuildVariant::STATIC      : builder = BVH4MBTSTriangle4iMBSceneBuilderSAH(accel,scene,0); break;
      case BuildVariant::DYNAMIC     : assert(false); break; // FIXME: implement
      case BuildVariant::HIGH_QUALITY: assert(false); break;
      }
    }
    else  if (scene->device->tri_builder_mb == "early_time_splits") builder = BVH4MBTSTriangle4iMBSceneBuilderSAH(accel,scene,0);
    else throw_RTCError(RTC_INVALID_ARGUMENT,"unknown builder "+scene->device->tri_builder_mb+" for BVH4MBTS<Triangle4iMB>");
