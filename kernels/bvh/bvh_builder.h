  ...
  namespace isa
  {
    ...
    template<int N>
      struct BVHNBuilderFastSpatial
      {
        ...
        struct BVHNBuilderV {
          void build(BVH* bvh, BuildProgressMonitor& progress, PrimRef* prims0, const PrimInfo& pinfo, 
                     const size_t blockSize, const size_t minLeafSize, const size_t maxLeafSize, const float travCost, const float intCost);
        ...
        static void build(BVH* bvh, CreateLeafFunc createLeaf, 
                          BuildProgressMonitor& progress, PrimRef* prims0, 
          ...
          BVHNBuilderT<CreateLeafFunc>(createLeaf).build(bvh,progress,prims0,pinfo,blockSize,minLeafSize,maxLeafSize,travCost,intCost);
        }
      };
