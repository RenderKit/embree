...
namespace embree
{
  namespace isa
  {
    ...
    Builder* BVH8Triangle4vSceneBuilderFastSpatialSAH  (void* bvh, Scene* scene, size_t mode) { return new BVHNBuilderFastSpatialSAH<8,TriangleMesh,Triangle4v,TriangleSplitter>((BVH8*)bvh,scene,4,1.0f,4,inf,mode); }
