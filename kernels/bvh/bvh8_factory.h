...
namespace embree
{
  ...
  private:
    ...
    Accel::Intersectors BVH8Triangle4iMB4DIntersectors(BVH8* bvh, IntersectVariant ivariant);
    Accel::Intersectors BVH8Triangle4vMB4DIntersectors(BVH8* bvh, IntersectVariant ivariant);
    Accel::Intersectors BVH8Triangle4iMBTSIntersectors(BVH8* bvh, IntersectVariant ivariant);
  ...
  private:
    ...
    DEFINE_SYMBOL2(Accel::Intersector1,BVH8Triangle4vMB4DIntersector1Moeller);
    DEFINE_SYMBOL2(Accel::Intersector1,BVH8Triangle4iMBTSIntersector1Moeller);
    ...
    DEFINE_SYMBOL2(Accel::Intersector4,BVH8Triangle4vMB4DIntersector4HybridMoeller);
    DEFINE_SYMBOL2(Accel::Intersector4,BVH8Triangle4iMBTSIntersector4HybridMoeller);
    ...
    DEFINE_SYMBOL2(Accel::Intersector8,BVH8Triangle4vMB4DIntersector8HybridMoeller);
    DEFINE_SYMBOL2(Accel::Intersector8,BVH8Triangle4iMBTSIntersector8HybridMoeller);
    ...
    DEFINE_SYMBOL2(Accel::Intersector16,BVH8Triangle4vMB4DIntersector16HybridMoeller);
    DEFINE_SYMBOL2(Accel::Intersector16,BVH8Triangle4iMBTSIntersector16HybridMoeller);
