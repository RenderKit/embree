...
RTHWIF_API ze_result_t_ ZE_APICALL_ zeRaytracingGetAccelSizeGPUExt( const ze_raytracing_build_accel_ext_desc_t* args, ze_raytracing_accel_size_ext_properties_t* pAccelSizeOut, void *sycl_queue, unsigned int verbose_level=0 );
RTHWIF_API ze_result_t_ ZE_APICALL_ zeRaytracingPrefetchAccelGPUExt( const ze_raytracing_build_accel_ext_desc_t* args, void *sycl_queue, unsigned int verbose_level=0 );

RTHWIF_API ze_result_t_ ZE_APICALL_ zeRaytracingBuildAccelGPUExt( const ze_raytracing_build_accel_ext_desc_t* args, void *sycl_queue, unsigned int verbose_level=0 );
