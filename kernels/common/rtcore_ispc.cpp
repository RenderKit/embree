...
#define ssize_t int  // FIXME: workaround for ISPC bug (ISPC bug still present in ISPC v1.8.2) 
  ...
  extern "C" void ispcIntersectNM (RTCScene scene, const RTCIntersectionContext* context, RTCRayN* rays, const size_t N, const size_t M, const size_t stride) {
    rtcIntersectNM(scene,context,rays,N,M,stride);
  }

  extern "C" void ispcIntersectNp (RTCScene scene, const RTCIntersectionContext* context, const RTCRayNp& rays, const  size_t N) {
  ...
  extern "C" void ispcOccludedNM (RTCScene scene, const RTCIntersectionContext* context, RTCRayN* rays, const size_t N, const  size_t M, const  size_t stride) {
    rtcOccludedNM(scene,context,(RTCRayN*)rays,N,M,stride);
  }

  extern "C" void ispcOccludedNp (RTCScene scene, const RTCIntersectionContext* context, const RTCRayNp& rays, const  size_t N) {
