...
namespace embree
{
  ...
  public:
	...
	const vfloat16 v0 = permute<0,0,0,0>(vfloat16::loadu(m_3f,vptr0_64));
	const vfloat16 v1 = permute<0,0,0,0>(vfloat16::loadu(m_3f,vptr1_64));
	const vfloat16 v2 = permute<0,0,0,0>(vfloat16::loadu(m_3f,vptr2_64));
