...
namespace embree
{
  ...
  ssize_t Device::getProperty(const RTCDeviceProperty prop)
  {
    ...
    case RTC_DEVICE_PROPERTY_INTERSECT1_SUPPORTED: return 1;

#if defined(EMBREE_TARGET_SIMD4) && defined(EMBREE_RAY_PACKETS)
    case RTC_DEVICE_PROPERTY_INTERSECT4_SUPPORTED:  return hasISA(SSE2);
#else
    case RTC_DEVICE_PROPERTY_INTERSECT4_SUPPORTED:  return 0;
#endif

#if defined(EMBREE_TARGET_SIMD8) && defined(EMBREE_RAY_PACKETS)
    case RTC_DEVICE_PROPERTY_INTERSECT8_SUPPORTED:  return hasISA(AVX);
#else
    case RTC_DEVICE_PROPERTY_INTERSECT8_SUPPORTED:  return 0;
#endif

#if defined(EMBREE_TARGET_SIMD16) && defined(EMBREE_RAY_PACKETS)
    case RTC_DEVICE_PROPERTY_INTERSECT16_SUPPORTED: return hasISA(AVX512KNL) | hasISA(AVX512SKX);
#else
    case RTC_DEVICE_PROPERTY_INTERSECT16_SUPPORTED: return 0;
#endif
    ...
    case RTC_DEVICE_PROPERTY_LINE_GEOMETRY_SUPPORTED: return 1;
#else
    case RTC_DEVICE_PROPERTY_LINE_GEOMETRY_SUPPORTED: return 0;
#endif

#if defined(EMBREE_GEOMETRY_CURVES)
    case RTC_DEVICE_PROPERTY_HAIR_GEOMETRY_SUPPORTED: return 1;
#else
