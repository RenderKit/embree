...
namespace embree
{
  ...
  void Scene::createTriangleMBAccel()
  {
    ...
    else if (device->tri_accel_mb == "bvh4mb4d.triangle4imb") accels.add(device->bvh4_factory->BVH4Triangle4iMB4D(this));
#if defined (__TARGET_AVX__)
    ...
    else if (device->tri_accel_mb == "bvh8mb4d.triangle4imb") accels.add(device->bvh8_factory->BVH8Triangle4iMB4D(this));
#endif
