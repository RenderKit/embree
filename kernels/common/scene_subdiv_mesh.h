...
namespace embree
{
  ...
  public:
    ...
    SubdivMesh(Device* device, RTCBuildQuality quality);
  ...
  namespace isa
  {
    ...
    {
      SubdivMeshISA (Device* device, RTCBuildQuality quality)
        : SubdivMesh(device,quality) {}
  ...
  DECLARE_ISA_FUNCTION(SubdivMesh*, createSubdivMesh, Device* COMMA RTCBuildQuality);
};
