...
namespace embree
{
    ...
    struct HitK
  {
      ...
      : Ng(Ng), u(u), v(v), primID(primID), geomID(geomID) 
    {
      ...
      instance_id_stack::copy<K>(context->instID, instID);
    }
    ...
    struct __aligned(16) HitK<1>
  {
    ...
    {
      instance_id_stack::copy1(context->instID, instID);
    }
    ...
    __forceinline void copyHitToRay(RayHit& ray, const Hit& hit)
  {
    ...
    instance_id_stack::copy1(hit.instID, ray.instID);
  }
    ...
    __forceinline void copyHitToRay(const vbool<K> &mask, RayHitK<K> &ray, const HitK<K> &hit)
  {
    ...
    instance_id_stack::copy<K>(hit.instID, ray.instID, mask);
  }
}
