...
namespace embree
{
  ...
  enum {
    ...
    BORDER_BEZIER_CURVE_TOP_SUBCURVE_0    = 1 << 0,
    BORDER_BEZIER_CURVE_TOP_SUBCURVE_1    = 1 << 1,

    BORDER_BEZIER_CURVE_RIGHT_SUBCURVE_0  = 1 << 2,
    BORDER_BEZIER_CURVE_RIGHT_SUBCURVE_1  = 1 << 3,

    BORDER_BEZIER_CURVE_BUTTOM_SUBCURVE_0 = 1 << 4,
    BORDER_BEZIER_CURVE_BUTTOM_SUBCURVE_1 = 1 << 5,

    BORDER_BEZIER_CURVE_LEFT_SUBCURVE_0   = 1 << 5,
    BORDER_BEZIER_CURVE_LEFT_SUBCURVE_1   = 1 << 6
  };

  __forceinline void printBorderTags(const int tags)
  {
    if (tags == BORDER_BEZIER_CURVE_IGNORE)         { PRINT("BORDER_BEZIER_CURVE_IGNORE"); return; }
    if (tags & BORDER_BEZIER_CURVE_TOP_SUBCURVE_0)    PRINT("BORDER_BEZIER_CURVE_TOP_SUBCURVE_0");
    if (tags & BORDER_BEZIER_CURVE_TOP_SUBCURVE_1)    PRINT("BORDER_BEZIER_CURVE_TOP_SUBCURVE_1");
    if (tags & BORDER_BEZIER_CURVE_RIGHT_SUBCURVE_0)  PRINT("BORDER_BEZIER_CURVE_RIGHT_SUBCURVE_0");
    if (tags & BORDER_BEZIER_CURVE_RIGHT_SUBCURVE_1)  PRINT("BORDER_BEZIER_CURVE_RIGHT_SUBCURVE_1");
    if (tags & BORDER_BEZIER_CURVE_BUTTOM_SUBCURVE_0) PRINT("BORDER_BEZIER_CURVE_BUTTOM_SUBCURVE_0");
    if (tags & BORDER_BEZIER_CURVE_BUTTOM_SUBCURVE_1) PRINT("BORDER_BEZIER_CURVE_BUTTOM_SUBCURVE_1");
    if (tags & BORDER_BEZIER_CURVE_LEFT_SUBCURVE_0)   PRINT("BORDER_BEZIER_CURVE_LEFT_SUBCURVE_0");
    if (tags & BORDER_BEZIER_CURVE_LEFT_SUBCURVE_1)   PRINT("BORDER_BEZIER_CURVE_LEFT_SUBCURVE_1");
  }
#else
  ...
  {
    if (tags == BORDER_BEZIER_CURVE_IGNORE) { PRINT("BORDER_BEZIER_CURVE_IGNORE"); return; }
    if (tags & BORDER_BEZIER_CURVE_FIRST)    PRINT("BORDER_BEZIER_CURVE_FIRST");
    if (tags & BORDER_BEZIER_CURVE_SECOND)   PRINT("BORDER_BEZIER_CURVE_SECOND");
  }
