...
namespace embree
{
  ...
  template<typename Vertex, typename Vertex_t = Vertex>
    ...
    public:
      ...
      static __forceinline mic4f eval_derivative(const float16 u, const bool16 m_mask)
      {
      ...
      {
        const mic4f v_e_d = eval_derivative(float16(vv),0x00ff);       // ev,ev,dv,dv
        ...
        const mic4f u_e_d = eval_derivative(float16(uu),0xff00);       // du,du,eu,eu
