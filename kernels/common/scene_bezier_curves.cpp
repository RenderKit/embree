...
namespace embree
{
  ...
  NativeCurves::NativeCurves (Device* device, RTCCurveType subtype, RTCCurveBasis basis) 
  ...
  namespace isa
  {
    ...
    NativeCurves* createCurvesBezier(Device* device, RTCCurveType subtype, RTCCurveBasis basis) {
    ...
    NativeCurves* createCurvesBSpline(Device* device, RTCCurveType subtype, RTCCurveBasis basis) {
