...
namespace embree
{
  ...
  public:
    ...
    __forceinline Vec2vf16 bounds_Vec2f16(size_t i) const 
    {
      ...
      const vfloat16 v0 = permute<0,0,0,0>(vfloat16::loadu(m_4f,cp0));
      const vfloat16 v1 = permute<0,0,0,0>(vfloat16::loadu(m_4f,cp1));
      const vfloat16 v2 = permute<0,0,0,0>(vfloat16::loadu(m_4f,cp2));
      const vfloat16 v3 = permute<0,0,0,0>(vfloat16::loadu(m_4f,cp3));
