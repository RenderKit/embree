...
RTC_API void rtcSetGeometryTransform(RTCGeometry hgeometry, unsigned int timeStep, RTCFormat format, const void* xfm)
  ...
  RTC_API RTCGeometry rtcNewGeometry (RTCDevice hdevice, RTCGeometryType type)
  {
    ...
    case RTC_GEOMETRY_TYPE_TRIANGLE:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createTriangleMesh);
    ...
    case RTC_GEOMETRY_TYPE_QUAD:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createQuadMesh);
    ...
    case RTC_GEOMETRY_TYPE_ORIENTED_DISC_POINT:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_builder_cpu_features, createPoints);
    ...
    case RTC_GEOMETRY_TYPE_NORMAL_ORIENTED_CATMULL_ROM_CURVE:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createLineSegments);
      createCurvesTy createCurves = nullptr;
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createCurves);
    ...
    case RTC_GEOMETRY_TYPE_SUBDIVISION:
    {
      ...
      //SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createSubdivMesh); // FIXME: this does not work for some reason?
    ...
    case RTC_GEOMETRY_TYPE_USER:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createUserGeometry);
    ...
    case RTC_GEOMETRY_TYPE_INSTANCE:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createInstance);
    ...
    case RTC_GEOMETRY_TYPE_INSTANCE_ARRAY:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createInstanceArray);
    ...
    case RTC_GEOMETRY_TYPE_GRID:
    {
      ...
      SELECT_SYMBOL_DEFAULT_AVX_AVX2_AVX512_AVX10_1_AVX10_2_APX(device->enabled_cpu_features,createGridMesh);
