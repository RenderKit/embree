  ...
  namespace isa
  {
    ...
    template<int M, int Mx, bool filter>
      struct TriangleMIntersector1Moeller
      {
        ...
        static __forceinline bool occluded(const Precalculations& pre, RayHit& ray, IntersectContext* context, const TriangleM<M>& tri)
        {
    ...
    template<int M, int Mx, int K, bool filter>
      struct TriangleMIntersectorKMoeller
      {
        ...
        static __forceinline vbool<K> occluded(const vbool<K>& valid_i, Precalculations& pre, RayHitK<K>& ray, IntersectContext* context, const TriangleM<M>& tri)
        {
        ...
        static __forceinline bool occluded(Precalculations& pre, RayHitK<K>& ray, size_t k, IntersectContext* context, const TriangleM<M>& tri)
        {
          STAT3(shadow.trav_prims,1,1,1);
