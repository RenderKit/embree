  ...
  namespace isa
  {
    ...
    template<typename Intersector1, typename Intersector2>
      struct Select2Intersector1
      {
        ...
        static __forceinline void intersect(Precalculations& pre, Ray& ray, IntersectContext* context, size_t ty, const Primitive* prim_i, size_t num, Scene* scene, size_t& lazy_node)
        {
          if (likely(ty == 0)) {
        ...
        static __forceinline bool occluded(Precalculations& pre, Ray& ray, IntersectContext* context, size_t ty, const Primitive* prim_i, size_t num, Scene* scene, size_t& lazy_node) 
        {
          if (likely(ty == 0)) {
            Primitive1 prim = (Primitive1) prim_i;
            for (size_t i=0; i<num; i++) {
