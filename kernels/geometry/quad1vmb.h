...
namespace embree
{
  ...
  public:
    ...
    /* Default constructor */
    __forceinline Quad1vMB() {}

    /* Construction from vertices and IDs */
    __forceinline Quad1vMB(const Vec3f& v0, const Vec3f& v1, const Vec3f& v2, const Vec3f& v3, const unsigned int geomID, const unsigned int primID)
