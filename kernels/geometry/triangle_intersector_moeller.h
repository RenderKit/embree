...
namespace embree
{
  namespace isa
  {
      ...
      struct MoellerTrumboreIntersector1
    {
      ...
      __forceinline MoellerTrumboreIntersector1(const RayHit& ray, const void* ptr) {}
      ...
      __forceinline bool intersectEdge(RayHit& ray,
                                       const Vec3vf<M>& tri_v0,
                                       const Vec3vf<M>& tri_e1,
                                       const Vec3vf<M>& tri_e2,
                                       MoellerTrumboreHitM<M>& hit) const
    ...
    {
      __forceinline MoellerTrumboreIntersectorK(const vbool<K>& valid, const RayHitK<K>& ray) {}
      ...
      /*! Intersect k'th ray from ray packet of size K with M triangles. */
        __forceinline bool intersectEdge(RayHitK<K>& ray,
                                         size_t k,
                                         const Vec3vf<M>& tri_v0, 
                                         const Vec3vf<M>& tri_e1, 
                                         const Vec3vf<M>& tri_e2, 
      ...
      template<typename Epilog>
      __forceinline bool intersect(RayHitK<K>& ray,
                                   size_t k,
                                   const Vec3vf<M>& v0, 
                                   const Vec3vf<M>& v1, 
                                   const Vec3vf<M>& v2, 
