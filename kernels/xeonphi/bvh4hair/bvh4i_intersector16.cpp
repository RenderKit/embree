...
namespace embree
{
  namespace isa
  {
    ...
    void BVH4iIntersector16BezierCurves<LeafIntersector>::intersect(mic_i* valid_i, BVH4i* bvh, Ray16& ray16)
    {
      /* near and node stack */
    ...
    template<typename LeafIntersector>    
    void BVH4iIntersector16BezierCurves<LeafIntersector>::occluded(mic_i* valid_i, BVH4i* bvh, Ray16& ray16)
    {
      /* near and node stack */
      __aligned(64) NodeRef stack_node[3*BVH4i::maxDepth+1];
    ...
    template<typename LeafIntersector>        
    void BVH4iIntersector1BezierCurves<LeafIntersector>::intersect(BVH4i* bvh, Ray& ray)
    {
      /* near and node stack */
      __aligned(64) float   stack_dist[3*BVH4i::maxDepth+1];
      __aligned(64) NodeRef stack_node[3*BVH4i::maxDepth+1];
    ...
    template<typename LeafIntersector>    
    void BVH4iIntersector1BezierCurves<LeafIntersector>::occluded(BVH4i* bvh, Ray& ray)
    {
      /* near and node stack */
      __aligned(64) NodeRef stack_node[3*BVH4i::maxDepth+1];
    ...
    DEFINE_INTERSECTOR16   (BVH4iBezierCurvesIntersector16, BVH4iIntersector16BezierCurves<Bezier1iLeafIntersector>);
    DEFINE_INTERSECTOR1    (BVH4iBezierCurvesIntersector1 , BVH4iIntersector1BezierCurves<Bezier1iLeafIntersector>);
