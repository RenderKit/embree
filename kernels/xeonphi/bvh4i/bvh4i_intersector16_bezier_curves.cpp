...
namespace embree
{
  namespace isa
  {
    ...
    void BVH4iIntersector16BezierCurves::intersect(mic_i* valid_i, BVH4i* bvh, Ray16& ray)
    {
      /* near and node stack */
...
#pragma unroll(4)
    ...
    void BVH4iIntersector16BezierCurves::occluded(mic_i* valid_i, BVH4i* bvh, Ray16& ray)
    {
      /* allocate stack */
      __aligned(64) mic_f    stack_dist[3*BVH4i::maxDepth+1];
      __aligned(64) NodeRef stack_node[3*BVH4i::maxDepth+1];
...
#pragma unroll(4)
    ...
    void BVH4iIntersector1BezierCurves::intersect(BVH4i* bvh, Ray& ray)
    {
      /* near and node stack */
    ...
    void BVH4iIntersector1BezierCurves::occluded(BVH4i* bvh, Ray& ray)
    {
      /* near and node stack */
      __aligned(64) NodeRef stack_node[3*BVH4i::maxDepth+1];
    ...
    DEFINE_INTERSECTOR16   (BVH4iBezierCurvesIntersector16, BVH4iIntersector16BezierCurves);
    DEFINE_INTERSECTOR1    (BVH4iBezierCurvesIntersector1 , BVH4iIntersector1BezierCurves);
