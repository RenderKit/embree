...
namespace embree
{
  namespace isa
  {
    ...
    void BVH4iIntersector16Chunk<LeafIntersector,ENABLE_COMPRESSED_BVH4I_NODES>::intersect(int16* valid_i, BVH4i* bvh, Ray16& ray)
    {
      /* near and node stack */
    ...
    template<typename LeafIntersector,bool ENABLE_COMPRESSED_BVH4I_NODES>
    void BVH4iIntersector16Chunk<LeafIntersector,ENABLE_COMPRESSED_BVH4I_NODES>::occluded(int16* valid_i, BVH4i* bvh, Ray16& ray)
    {
      /* allocate stack */
      __aligned(64) float16    stack_dist[3*BVH4i::maxDepth+1];
      __aligned(64) NodeRef stack_node[3*BVH4i::maxDepth+1];
