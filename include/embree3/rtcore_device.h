...
enum RTCDeviceProperty {
  ...
  RTC_DEVICE_PROPERTY_LINE_GEOMETRY_SUPPORTED = 19,        //!< flag whether line geometries are supported (read only)
  RTC_DEVICE_PROPERTY_HAIR_GEOMETRY_SUPPORTED = 20,        //!< flag whether hair geometries are supported (read only)
