...
RTCORE_API void rtcIntersectNM (RTCScene scene, const RTCIntersectionContext* context, struct RTCRayN* rays, const size_t N, const size_t M, const size_t stride);
 ...
 *  of the ray packet. */
RTCORE_API void rtcIntersectNp (RTCScene scene, const RTCIntersectionContext* context, const RTCRayNp& rays, const size_t N);
 ...
 *  RTC_INTERSECT_STREAM flag set. The stride specifies the offset between
 *  rays in bytes.*/
RTCORE_API void rtcOccludedNM (RTCScene scene, const RTCIntersectionContext* context, struct RTCRayN* rays, const size_t N, const size_t M, const size_t stride);
 ...
 *  this function accepts a separate data pointer for each component
 *  of the ray packet. */
RTCORE_API void rtcOccludedNp (RTCScene scene, const RTCIntersectionContext* context, const RTCRayNp& rays, const size_t N);
