...
ids = pe.rtcRayHits_get_rayids(rayhits, True)
ox = pe.rtcRayHits_get_orgx(rayhits, True)
oy = pe.rtcRayHits_get_orgy(rayhits, True)
oz = pe.rtcRayHits_get_orgz(rayhits, True)
dx = pe.rtcRayHits_get_dirx(rayhits, True)
dy = pe.rtcRayHits_get_diry(rayhits, True)
dz = pe.rtcRayHits_get_dirz(rayhits, True)
tfar = pe.rtcRayHits_get_tfar(rayhits, True)
...
sdy = LQ[1] - soy
sdz = LQ[2] - soz
l = 1.0 / np.sqrt(sdx * sdx + sdy * sdy + sdz * sdz)
sdx = sdx * l
sdy = sdy * l
sdz = sdz * l
sox = sox + sdx * 0.001
...
shadowrayhits2 = pe.rtcCreateRayHits(sox, soy, soz, sdx, sdy, sdz, ids)
...
print(f"    ...{len(shadowrayhits2)} generated")

print(f"ids:  {pe.rtcRayHits_get_rayids(shadowrayhits, False)}")
print(f"ids:  {pe.rtcRayHits_get_rayids(shadowrayhits2, False)}")
print(f"x:  {pe.rtcRayHits_get_orgx(shadowrayhits, False)}")
print(f"x:  {pe.rtcRayHits_get_orgx(shadowrayhits2, False)}")
print(f"y:  {pe.rtcRayHits_get_orgy(shadowrayhits, False)}")
print(f"y:  {pe.rtcRayHits_get_orgy(shadowrayhits2, False)}")
print(f"z:  {pe.rtcRayHits_get_orgz(shadowrayhits, False)}")
print(f"z:  {pe.rtcRayHits_get_orgz(shadowrayhits2, False)}")
print(f"dx: {pe.rtcRayHits_get_dirx(shadowrayhits, False)}")
print(f"dx: {pe.rtcRayHits_get_dirx(shadowrayhits2, False)}")
print(f"dy: {pe.rtcRayHits_get_diry(shadowrayhits, False)}")
print(f"dy: {pe.rtcRayHits_get_diry(shadowrayhits2, False)}")
print(f"dz: {pe.rtcRayHits_get_dirz(shadowrayhits, False)}")
print(f"dz: {pe.rtcRayHits_get_dirz(shadowrayhits2, False)}")

shadowrayhits = shadowrayhits2
