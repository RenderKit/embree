...
#define _MM_SHUF_PERM3(e1, e0) \
  ...
  __forceinline long toScalar(const vlong4& a)
  {
  ...
  __forceinline long reduce_add(const vlong4& a) { return toScalar(vreduce_add(a)); }
  __forceinline long reduce_or (const vlong4& a) { return toScalar(vreduce_or(a)); }
  __forceinline long reduce_and(const vlong4& a) { return toScalar(vreduce_and(a)); }
