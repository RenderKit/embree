...
namespace embree
{
  ...
  __forceinline vboolf8 operator !(const vboolf8& a) { return _knot_mask8(a); }
#else
...
#if defined(__AVX10_2__)
  __forceinline vboolf8 operator &(const vboolf8& a, const vboolf8& b) { return _kand_mask8(a, b); }
  __forceinline vboolf8 operator |(const vboolf8& a, const vboolf8& b) { return _kor_mask8(a, b); }
  __forceinline vboolf8 operator ^(const vboolf8& a, const vboolf8& b) { return _kxor_mask8(a, b); }

  __forceinline vboolf8 andn(const vboolf8& a, const vboolf8& b) { return _kandn_mask8(b, a); }
#else
...
#if defined(__AVX10_2__)
  __forceinline vboolf8 operator !=(const vboolf8& a, const vboolf8& b) { return _kxor_mask8(a, b); }
  __forceinline vboolf8 operator ==(const vboolf8& a, const vboolf8& b) { return _kxnor_mask8(a, b); }
  ...
  __forceinline int any (const vboolf8& a) { return _kortestz_mask8_u8(a, a) == 0; }
  __forceinline int none(const vboolf8& a) { return _kortestz_mask8_u8(a, a) != 0; }
#else
  __forceinline int all (const vboolf8& a) { return a.v == 0xff; }
...
#if defined(__AVX10_2__)
  __forceinline size_t movemask(const vboolf8& a) { return _cvtmask8_u32(a); }
#else
