...
namespace embree
{
  ...
  __forceinline vboolf4 operator !(const vboolf4& a) { return _kandn_mask8(a, (__mmask8)0xf); }
#else
...
#if defined(__AVX10_2__)
  __forceinline vboolf4 operator &(const vboolf4& a, const vboolf4& b) { return _kand_mask8(a, b); }
  __forceinline vboolf4 operator |(const vboolf4& a, const vboolf4& b) { return _kor_mask8(a, b); }
  __forceinline vboolf4 operator ^(const vboolf4& a, const vboolf4& b) { return _kxor_mask8(a, b); }

  __forceinline vboolf4 andn(const vboolf4& a, const vboolf4& b) { return _kandn_mask8(b, a); }
#else
...
#if defined(__AVX10_2__)
  __forceinline vboolf4 operator !=(const vboolf4& a, const vboolf4& b) { return _kxor_mask8(a, b); }
  __forceinline vboolf4 operator ==(const vboolf4& a, const vboolf4& b) { return _kand_mask8(_kxnor_mask8(a, b), (__mmask8)0xf); }
  ...
  __forceinline int any (const vboolf4& a) { return _kortestz_mask8_u8(a, a) == 0; }
  __forceinline int none(const vboolf4& a) { return _kortestz_mask8_u8(a, a) != 0; }
#else
  __forceinline int all (const vboolf4& a) { return a.v == 0xf; }
...
#if defined(__AVX10_2__)
  __forceinline size_t movemask(const vboolf4& a) { return _cvtmask8_u32(a); }
#else
