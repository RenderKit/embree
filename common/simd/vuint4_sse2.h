...
namespace embree
{
  ...
  struct vuint<4>
  {
    ...
    __forceinline vuint( const unsigned& a ) : v(_mm_shuffle_epi32(_mm_castps_si128(_mm_load_ss((float*)&a)), _MM_SHUFFLE(0, 0, 0, 0))) {}
#if defined(__X86_64__)
    __forceinline vuint( const size_t a  ) : v(_mm_set1_epi32((int)a)) {}
#endif
    ...
    __forceinline static vuint4 undefined() { return _mm_undefined_si128(); }
    ...
    static __forceinline vuint4 load ( const void* const a ) { return _mm_load_si128((__m128i*)a); }
    static __forceinline vuint4 loadu( const void* const a ) { return _mm_loadu_si128((__m128i*)a); }
...
#if defined(__AVX512VL__)
    static __forceinline vuint4 load ( const vboolf4& mask, const void* const ptr ) { return _mm_mask_load_epi32 (_mm_setzero_si128(),mask,ptr); }
    static __forceinline vuint4 loadu( const vboolf4& mask, const void* const ptr ) { return _mm_mask_loadu_epi32(_mm_setzero_si128(),mask,ptr); }
    ...
    static __forceinline vuint4 load ( const vbool4& mask, const void* const a ) { return _mm_castps_si128(_mm_maskload_ps((float*)a,mask)); }
    static __forceinline vuint4 loadu( const vbool4& mask, const void* const a ) { return _mm_castps_si128(_mm_maskload_ps((float*)a,mask)); }
...
#else
    static __forceinline vuint4 load ( const vbool4& mask, const void* const a ) { return _mm_and_si128(_mm_load_si128 ((__m128i*)a),mask); }
    static __forceinline vuint4 loadu( const vbool4& mask, const void* const a ) { return _mm_and_si128(_mm_loadu_si128((__m128i*)a),mask); }
    ...
    static __forceinline vuint4 load( const unsigned char* const ptr ) {
      return _mm_cvtepu8_epi32(_mm_load_si128((__m128i*)ptr));
    }

    static __forceinline vuint4 loadu( const unsigned char* const ptr ) {
      return  _mm_cvtepu8_epi32(_mm_loadu_si128((__m128i*)ptr));
    }

#endif

    static __forceinline vuint4 load(const unsigned short* const ptr) {
#if defined (__SSE4_1__)
    ...
    static __forceinline void store_uchar( unsigned char* const ptr, const vuint4& v ) {
#if defined(__SSE4_1__)
      __m128i x = v;
    ...
    static __forceinline void store_uchar( unsigned short* const ptr, const vuint4& v ) {
      for (size_t i=0;i<4;i++)
    ...
    __forceinline const unsigned& operator []( const size_t index ) const { assert(index < 4); return i[index]; }
    __forceinline       unsigned& operator []( const size_t index )       { assert(index < 4); return i[index]; }

    friend __forceinline const vuint4 select( const vboolf4& m, const vuint4& t, const vuint4& f ) {
#if defined(__AVX512VL__)
  ...
  __forceinline const vuint4 operator +( const vuint4& a, const vuint4& b ) { return _mm_add_epi32(a.v, b.v); }
  ...
  __forceinline const vuint4 operator -( const vuint4& a, const vuint4& b ) { return _mm_sub_epi32(a.v, b.v); }
  __forceinline const vuint4 operator -( const vuint4& a, const unsigned&   b ) { return a - vuint4(b); }
  __forceinline const vuint4 operator -( const unsigned&   a, const vuint4& b ) { return vuint4(a) - b; }
...
//  __forceinline const vuint4 operator *( const unsigned&   a, const vuint4& b ) { return vuint4(a) * b; }
  ...
  __forceinline const vuint4 operator |( const vuint4& a, const vuint4& b ) { return _mm_or_si128(a.v, b.v); }
  __forceinline const vuint4 operator |( const vuint4& a, const unsigned&   b ) { return a | vuint4(b); }
  __forceinline const vuint4 operator |( const unsigned&   a, const vuint4& b ) { return vuint4(a) | b; }

  __forceinline const vuint4 operator ^( const vuint4& a, const vuint4& b ) { return _mm_xor_si128(a.v, b.v); }
  __forceinline const vuint4 operator ^( const vuint4& a, const unsigned&   b ) { return a ^ vuint4(b); }
  __forceinline const vuint4 operator ^( const unsigned&   a, const vuint4& b ) { return vuint4(a) ^ b; }
  ...
  __forceinline const vuint4 srl ( const vuint4& a, const unsigned& b ) { return _mm_srli_epi32(a.v, b); }
...
//#endif
  ...
  template<int mask>
  __forceinline const vuint4 select(const vuint4& t, const vuint4& f) {
#if defined(__SSE4_1__) 
...
/*#if defined(__SSE4_1__)
  ...
  __forceinline const vuint4 max( const vuint4& a, const vuint4& b ) { return select(a < b,b,a); }
#endif
  ...
  __forceinline vuint4 unpacklo( const vuint4& a, const vuint4& b ) { return _mm_castps_si128(_mm_unpacklo_ps(_mm_castsi128_ps(a.v), _mm_castsi128_ps(b.v))); }
  __forceinline vuint4 unpackhi( const vuint4& a, const vuint4& b ) { return _mm_castps_si128(_mm_unpackhi_ps(_mm_castsi128_ps(a.v), _mm_castsi128_ps(b.v))); }

  template<size_t i0, size_t i1, size_t i2, size_t i3> __forceinline const vuint4 shuffle( const vuint4& a ) {
    return _mm_shuffle_epi32(a, _MM_SHUFFLE(i3, i2, i1, i0));
  }

  template<size_t i0, size_t i1, size_t i2, size_t i3> __forceinline const vuint4 shuffle( const vuint4& a, const vuint4& b ) {
    return _mm_castps_si128(_mm_shuffle_ps(_mm_castsi128_ps(a), _mm_castsi128_ps(b), _MM_SHUFFLE(i3, i2, i1, i0)));
  }

#if defined(__SSE3__)
  template<> __forceinline const vuint4 shuffle<0, 0, 2, 2>( const vuint4& a ) { return _mm_castps_si128(_mm_moveldup_ps(_mm_castsi128_ps(a))); }
  template<> __forceinline const vuint4 shuffle<1, 1, 3, 3>( const vuint4& a ) { return _mm_castps_si128(_mm_movehdup_ps(_mm_castsi128_ps(a))); }
  template<> __forceinline const vuint4 shuffle<0, 1, 0, 1>( const vuint4& a ) { return _mm_castpd_si128(_mm_movedup_pd (_mm_castsi128_pd(a))); }
#endif

  template<size_t i0> __forceinline const vuint4 shuffle( const vuint4& b ) {
    return shuffle<i0,i0,i0,i0>(b);
  }

#if defined(__SSE4_1__)
  template<size_t src> __forceinline unsigned extract( const vuint4& b ) { return _mm_extract_epi32(b, src); }
  template<size_t dst> __forceinline const vuint4 insert( const vuint4& a, const unsigned b ) { return _mm_insert_epi32(a, b, dst); }
#else
  template<size_t src> __forceinline unsigned extract( const vuint4& b ) { return b[src]; }
  template<size_t dst> __forceinline const vuint4 insert( const vuint4& a, const unsigned b ) { vuint4 c = a; c[dst] = b; return c; }
#endif


  template<> __forceinline unsigned extract<0>( const vuint4& b ) { return _mm_cvtsi128_si32(b); }

  __forceinline unsigned toScalar(const vuint4& a) { return _mm_cvtsi128_si32(a); }
  ...
  __forceinline const vuint4 vreduce_max(const vuint4& v) { vuint4 h = max(shuffle<1,0,3,2>(v),v); return max(shuffle<2,3,0,1>(h),h); }
  __forceinline const vuint4 vreduce_add(const vuint4& v) { vuint4 h = shuffle<1,0,3,2>(v)   + v ; return shuffle<2,3,0,1>(h)   + h ; }

  __forceinline unsigned reduce_min(const vuint4& v) { return toScalar(vreduce_min(v)); }
  __forceinline unsigned reduce_max(const vuint4& v) { return toScalar(vreduce_max(v)); }
  __forceinline unsigned reduce_add(const vuint4& v) { return toScalar(vreduce_add(v)); }
  ...
  __forceinline unsigned reduce_min(const vuint4& v) { return min(v[0],v[1],v[2],v[3]); }
