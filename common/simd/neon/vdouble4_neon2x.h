...
namespace embree
{
  ...
  struct vdouble<4>
  {
    ...
    __forceinline vdouble4 &operator=(const vdouble4 &f)
    {
      v = f.v;
      return *this;
    }

    __forceinline vdouble(const float64x2_t &a_lo, const float64x2_t &a_hi)
    {
      v.lo = a_lo;
      v.hi = a_hi;
    }
    ...
    __forceinline vdouble(ZeroTy)
    {
      v.lo = vdupq_n_f64(0.0);
      v.hi = vdupq_n_f64(0.0);
    }
    __forceinline vdouble(OneTy)
    {
      v.lo = vdupq_n_f64(1.0);
      v.hi = vdupq_n_f64(1.0);
    }
    ...
    __forceinline double &operator[](size_t index)
    {
      assert(index < 4);
      return i[index];
    }
    __forceinline const double &operator[](size_t index) const
    {
      assert(index < 4);
      return i[index];
    }
  ...
  {
    vboold4 r;
    r.v.vl = vreinterpretq_f64_u64(vceqq_f64(a.v.lo, b.v.lo));
    r.v.vh = vreinterpretq_f64_u64(vceqq_f64(a.v.hi, b.v.hi));
    return r;
  }
  __forceinline vboold4 operator!=(const vdouble4 &a, const vdouble4 &b)
  {
    vboold4 r;
    r.v.vl = vreinterpretq_f64_u32(vmvnq_u32(vreinterpretq_u32_u64(vceqq_f64(a.v.lo, b.v.lo))));
    r.v.vh = vreinterpretq_f64_u32(vmvnq_u32(vreinterpretq_u32_u64(vceqq_f64(a.v.hi, b.v.hi))));
    return r;
  }
  __forceinline vboold4 operator<(const vdouble4 &a, const vdouble4 &b)
  {
    vboold4 r;
    r.v.vl = vreinterpretq_f64_u64(vcltq_f64(a.v.lo, b.v.lo));
    r.v.vh = vreinterpretq_f64_u64(vcltq_f64(a.v.hi, b.v.hi));
    return r;
  }
  __forceinline vboold4 operator>=(const vdouble4 &a, const vdouble4 &b)
  {
    vboold4 r;
    r.v.vl = vreinterpretq_f64_u64(vcgeq_f64(a.v.lo, b.v.lo));
    r.v.vh = vreinterpretq_f64_u64(vcgeq_f64(a.v.hi, b.v.hi));
    return r;
  }
  __forceinline vboold4 operator>(const vdouble4 &a, const vdouble4 &b)
  {
    vboold4 r;
    r.v.vl = vreinterpretq_f64_u64(vcgtq_f64(a.v.lo, b.v.lo));
    r.v.vh = vreinterpretq_f64_u64(vcgtq_f64(a.v.hi, b.v.hi));
    return r;
  }
  __forceinline vboold4 operator<=(const vdouble4 &a, const vdouble4 &b)
  {
    vboold4 r;
    r.v.vl = vreinterpretq_f64_u64(vcleq_f64(a.v.lo, b.v.lo));
    r.v.vh = vreinterpretq_f64_u64(vcleq_f64(a.v.hi, b.v.hi));
    return r;
  }
  ...
  __forceinline vdouble4 vreduce_min(const vdouble4 &y)
  {
    const vdouble4 x = vreduce_min2(y);
    return min(x, shuffle2<1, 0>(x));
  }

  __forceinline vdouble4 vreduce_max2(const vdouble4 &x) { return max(x, shuffle<1, 0>(x)); }
  __forceinline vdouble4 vreduce_max(const vdouble4 &y)
  {
    const vdouble4 x = vreduce_max2(y);
    return max(x, shuffle2<1, 0>(x));
  }

  __forceinline vdouble4 vreduce_and2(const vdouble4 &x) { return x & shuffle<1, 0>(x); }
  __forceinline vdouble4 vreduce_and(const vdouble4 &y)
  {
    const vdouble4 x = vreduce_and2(y);
    return x & shuffle2<1, 0>(x);
  }

  __forceinline vdouble4 vreduce_or2(const vdouble4 &x) { return x | shuffle<1, 0>(x); }
  __forceinline vdouble4 vreduce_or(const vdouble4 &y)
  {
    const vdouble4 x = vreduce_or2(y);
    return x | shuffle2<1, 0>(x);
  }
