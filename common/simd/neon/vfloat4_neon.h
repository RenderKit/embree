...
namespace embree
{
  ...
  struct vfloat<4>
  {
    ...
    __forceinline vfloat(float32x4_t a) : v(a) {}
    __forceinline operator const float32x4_t &() const { return v; }
    __forceinline operator float32x4_t &() { return v; }
    ...
    {
      float lanes[4] = {0.0f, 1.0f, 2.0f, 3.0f};
      v = vld1q_f32(lanes);
    }
  ...
  template <int i>
  __forceinline float extract(const vfloat4 &a) { return a[i]; }

  template <int dst, int src>
  __forceinline vfloat4 insert(const vfloat4 &a, const vfloat4 &b)
  {
    vfloat4 c = a;
    c[dst & 3] = b[src & 3];
    return c;
  ...
  template <int dst>
  __forceinline vfloat4 insert(const vfloat4 &a, float b)
  {
    vfloat4 c = a;
    c[dst & 3] = b;
    return c;
