...
namespace embree
{
  ...
  __aligned(64) void (* TaskScheduler::taskPtr)(void* data, const size_t threadID, const size_t numThreads) = NULL;
  ...
  void TaskScheduler::dispatchTaskMainLoop(const size_t threadID, const size_t numThreads)
  {
    while (true) {
  ...
  void TaskScheduler::releaseThreads(const size_t numThreads)
  {
    taskPtr = NULL;
    data = NULL;
