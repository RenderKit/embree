...
IF (WIN32)
  ...
  INSTALL(PROGRAMS ${TBB_BINDIR}/tbb.dll ${TBB_BINDIR}/tbbmalloc.dll DESTINATION ${LIB_INSTALL_DIR} COMPONENT lib)
ELSEIF (NOT ENABLE_INSTALLER)
  IF (APPLE)
    INSTALL(PROGRAMS ${TBB_ROOT}/lib/libc++/libtbb.dylib ${TBB_ROOT}/lib/libc++/libtbbmalloc.dylib DESTINATION ${LIB_INSTALL_DIR} COMPONENT lib)
  ELSE()
    INSTALL(PROGRAMS ${TBB_ROOT}/lib/intel64/gcc4.4/libtbb.so.2 ${TBB_ROOT}/lib/intel64/gcc4.4/libtbbmalloc.so.2 DESTINATION ${LIB_INSTALL_DIR} COMPONENT lib)
  ENDIF()
ENDIF()
