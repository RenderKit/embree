...
ELSE ()
  ...
  SET(TBB_INCLUDE_DIR_MIC TBB_INCLUDE_DIR_MIC-NOTFOUND)
  SET(TBB_LIBRARY_MIC TBB_LIBRARY_MIC-NOTFOUND)
  SET(TBB_LIBRARY_MALLOC_MIC TBB_LIBRARY_MALLOC_MIC-NOTFOUND)
...
ELSEIF (NOT ENABLE_INSTALLER)
  ...
  ELSE()
    INSTALL(PROGRAMS ${TBB_ROOT}/lib/intel64/gcc4.4/libtbb.dylib ${TBB_ROOT}/lib/intel64/gcc4.4/libtbbmalloc.dylib DESTINATION lib COMPONENT lib)
  ENDIF()
ENDIF()
