...
ELSE()
  ...
  IF(EMBREE_IGNORE_CMAKE_CXX_FLAGS)
    IF(CMAKE_CXX_FLAGS)
      MESSAGE(WARNING "Ignoring CMAKE_CXX_FLAGS because EMBREE_IGNORE_CMAKE_CXX_FLAGS is enabled. Configure with EMBREE_IGNORE_CMAKE_CXX_FLAGS=OFF to honor CMAKE_CXX_FLAGS. Ignored value: '${CMAKE_CXX_FLAGS}'")
    ENDIF()
    SET(CMAKE_CXX_FLAGS "")
  ENDIF()
