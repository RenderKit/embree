...
ELSE ()
  ...
  _SET_IF_EMPTY(FLAGS_AVX512 "-march=skx")
  _SET_IF_EMPTY(FLAGS_AVX10_1 "${FLAGS_AVX2} -mavx10.1-512")
  _SET_IF_EMPTY(FLAGS_AVX10_2 "${FLAGS_AVX2} -mavx10.2-512")
  _SET_IF_EMPTY(FLAGS_APX "${FLAGS_AVX10_2} -mapx-features")
ENDIF ()
