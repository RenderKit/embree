...
SET(CMAKE_STRIP "${PROJECT_SOURCE_DIR}/scripts/strip.sh") # need this to properly strip under MacOSX
...
IF(WIN32)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_win.bat ${CMAKE_BUILD_TYPE} ${CPACK_PACKAGE_FILE_NAME}.exe ${EMBREE_SIGN_FILE})
    ENDIF()
  ELSE()
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_win.bat ${CMAKE_BUILD_TYPE} ${CPACK_PACKAGE_FILE_NAME}.zip ${EMBREE_SIGN_FILE})
    ENDIF()
  ENDIF()
...
ELSEIF(APPLE)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_macosx.sh ${CMAKE_BUILD_TYPE} ${CPACK_PACKAGE_FILE_NAME}.dmg ${EMBREE_SIGN_FILE})
    ENDIF()
  ELSE()
