...
IF(WIN32)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_win.bat ${CPACK_PACKAGE_FILE_NAME}.exe)
    ENDIF()
  ELSE()
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_win.bat ${CPACK_PACKAGE_FILE_NAME}.zip)
    ENDIF()
  ENDIF()
...
ELSEIF(APPLE)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_macosx.sh ${CPACK_PACKAGE_FILE_NAME}.dmg)
    ENDIF()
  ELSE()
    ...
    SET(CPACK_MONOLITHIC_INSTALL 1)
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_macosx.sh ${CPACK_PACKAGE_FILE_NAME}.tgz)
    ENDIF()
  ENDIF()
...
ELSE()
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ...
      set_tests_properties("BuildPackage" PROPERTIES ATTACHED_FILES version.h)
    ENDIF()
  ELSE()
