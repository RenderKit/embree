...
IF(WIN32)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      #ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${CMAKE_COMMAND} --build . --config ${CMAKE_BUILD_TYPE} --target PACKAGE)
      #SET_TESTS_PROPERTIES("BuildPackage" PROPERTIES ATTACHED_FILES ${CPACK_PACKAGE_FILE_NAME}.exe)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_win.bat ${CMAKE_BUILD_TYPE} ${CPACK_PACKAGE_FILE_NAME}.exe)
    ENDIF()
  ELSE()
    ...
    IF (EMBREE_TESTING_PACKAGE)
      #ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${CMAKE_COMMAND} --build . --config ${CMAKE_BUILD_TYPE} --target PACKAGE)
      #SET_TESTS_PROPERTIES("BuildPackage" PROPERTIES ATTACHED_FILES ${CPACK_PACKAGE_FILE_NAME}.zip)
...
ELSEIF(APPLE)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      #ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${CMAKE_COMMAND} --build . --config ${CMAKE_BUILD_TYPE} --target package)
      #SET_TESTS_PROPERTIES("BuildPackage" PROPERTIES ATTACHED_FILES ${CPACK_PACKAGE_FILE_NAME}.dmg)
  ...
  ELSE()
    ...
    SET(CPACK_MONOLITHIC_INSTALL 1)
    IF (EMBREE_TESTING_PACKAGE)
      #ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND COMMAND ${CMAKE_COMMAND} --build . --config ${CMAKE_BUILD_TYPE} --target package)
      #SET_TESTS_PROPERTIES("BuildPackage" PROPERTIES ATTACHED_FILES ${CPACK_PACKAGE_FILE_NAME}.tgz)
...
ELSE()
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ...
      #SET_TESTS_PROPERTIES("BuildPackage" PROPERTIES ATTACHED_FILES embree-${EMBREE_VERSION}.x86_64.rpm.tar.gz)
    ENDIF()
  ELSE()
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_linux.sh ${EMBREE_ZIP_MODE} ${EMBREE_VERSION})
      #SET_TESTS_PROPERTIES("BuildPackage" PROPERTIES ATTACHED_FILES embree-${EMBREE_VERSION}.x86_64.linux.tar.gz)
    ENDIF()
  ENDIF()
