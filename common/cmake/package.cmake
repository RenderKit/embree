...
# SYCL library
IF (EMBREE_DPCPP_SUPPORT AND EMBREE_INSTALL_DEPENDENCIES)
  ...
  ELSE()
    INSTALL(FILES "${DPCPP_COMPILER_DIR}/../lib/libsycl.so.5" DESTINATION "${CMAKE_INSTALL_LIBDIR}" COMPONENT lib)
    INSTALL(FILES "${DPCPP_COMPILER_DIR}/../lib/libpi_level_zero.so" DESTINATION "${CMAKE_INSTALL_LIBDIR}" COMPONENT lib)
    INSTALL(FILES "${DPCPP_COMPILER_DIR}/../lib/libze_loader.so.1" DESTINATION "${CMAKE_INSTALL_LIBDIR}" COMPONENT lib)
  ENDIF()
ENDIF()
