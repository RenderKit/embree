...
# Install Models
##############################################################
INSTALL(DIRECTORY tutorials/models DESTINATION "${CMAKE_INSTALL_BINDIR}" COMPONENT examples_xeonphi)

##############################################################
# Install Documentation
##############################################################

#INSTALL(FILES ${PROJECT_SOURCE_DIR}/LICENSE.txt DESTINATION ${CMAKE_INSTALL_DOCDIR} COMPONENT lib_xeonphi)
#INSTALL(FILES ${PROJECT_SOURCE_DIR}/CHANGELOG.md DESTINATION ${CMAKE_INSTALL_DOCDIR} COMPONENT lib_xeonphi)
#INSTALL(FILES ${PROJECT_SOURCE_DIR}/README.md DESTINATION ${CMAKE_INSTALL_DOCDIR} COMPONENT lib_xeonphi)
#INSTALL(FILES ${PROJECT_SOURCE_DIR}/readme.pdf DESTINATION ${CMAKE_INSTALL_DOCDIR} COMPONENT lib_xeonphi)
...
SET(CPACK_PACKAGE_FILE_NAME "embree-knc-${EMBREE_VERSION}")
...
SET(CPACK_COMPONENT_DEVEL_DEPENDS lib_xeonphi)
#SET(CPACK_COMPONENT_EXAMPLES_DEPENDS lib)
SET(CPACK_COMPONENT_EXAMPLES_XEONPHI_DEPENDS lib_xeonphi)
SET(CPACK_COMPONENT_LIB_XEONPHI_REQUIRED ON) # always install the libs
...
ELSEIF(APPLE)
  ...
  IF (NOT RTCORE_ZIP_MODE)
    ...
    SET(CPACK_COMPONENTS_ALL lib_xeonphi devel examples_xeonphi)
    SET(CPACK_MONOLITHIC_INSTALL 1)
...
ELSE()
  ...
  IF (NOT RTCORE_ZIP_MODE)
    ...
    SET(CPACK_COMPONENTS_ALL devel lib_xeonphi examples_xeonphi)
