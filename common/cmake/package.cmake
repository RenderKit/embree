...
IF(WIN32)
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND ${CMAKE_COMMAND} --build . --config Release --target PACKAGE)
...
ELSEIF(APPLE)
  ...
  ELSE()
    ...
    SET(CPACK_MONOLITHIC_INSTALL 1)
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND COMMAND ${CMAKE_COMMAND} --build . --config Release --target PACKAGE)
...
ELSE()
  ...
  IF (NOT EMBREE_ZIP_MODE)
    ...
    IF (EMBREE_TESTING_PACKAGE)
      ADD_TEST(NAME "BuildPackage" WORKING_DIRECTORY ${MY_PROJECT_BINARY_DIR} COMMAND ${PROJECT_SOURCE_DIR}/scripts/package_linux.sh ${EMBREE_ZIP_MODE} ${EMBREE_VERSION})
