...
IF (ENABLE_INSTALLER)
  INSTALL(FILES "${PROJECT_BINARY_DIR}/embree-config.cmake" DESTINATION "lib/cmake/embree-${EMBREE_VERSION}" COMPONENT headers)
  INSTALL(FILES "${PROJECT_BINARY_DIR}/embree-config-version.cmake" DESTINATION "lib/cmake/embree-${EMBREE_VERSION}" COMPONENT headers)
ENDIF()
...
SET(CPACK_COMPONENT_DOCUMENTATION_GROUP lib)
SET(CPACK_COMPONENT_GROUP_DEVEL_DISPLAY_NAME "Library")
SET(CPACK_COMPONENT_GROUP_DEVEL_DESCRIPTION "Embree Library files.")
SET(CPACK_COMPONENT_DEVEL_DESCRIPTION ${CPACK_COMPONENT_GROUP_DEVEL_DESCRIPTION})

# xeon phi library install groups
SET(CPACK_COMPONENT_LIBRARIES_XEONPHI_GROUP lib_xeonphi)
...
SET(CPACK_COMPONENT_LIB_XEONPHI_DESCRIPTION "${CPACK_COMPONENT_GROUP_DEVEL_DESCRIPTION}\n${XEONPHI_DESCRIPTION}")
