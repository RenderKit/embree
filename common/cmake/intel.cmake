...
IF (WIN32)
  ...
  IF (NOT EMBREE_STATIC_RUNTIME)
    ...
    STRING(APPEND CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO " /nodefaultlib:libmmdd.lib")
    ...
    STRING(APPEND CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO " /nodefaultlib:libmmdd.lib")
