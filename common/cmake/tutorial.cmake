...
TARGET_LINK_LIBRARIES(${TUTORIAL_NAME} embree tasking tutorial image transport tutorial_device ${ADDITIONAL_LIBRARIES})
...
IF (ENABLE_ISPC_SUPPORT)
  ...
  TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_ispc embree tasking tutorial image transport tutorial_device_ispc)
...
IF (ENABLE_XEON_PHI_SUPPORT)
  IF (__HOST__)
    ...
    TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_xeonphi tutorial tasking image transport_host)
  ...
  ELSE()
    ...
    TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_xeonphi_device embree_xeonphi tasking_xeonphi transport_device tutorial_xeonphi_device_ispc)
