...
IF (USE_TBB)
  ADD_DEFINITIONS(-DUSE_TBB)  # FIXME: 
ENDIF()
...
INSTALL(TARGETS ${TUTORIAL_NAME} DESTINATION bin)
...
IF (ENABLE_ISPC_SUPPORT)
  ...
  INSTALL(TARGETS ${TUTORIAL_NAME}_ispc DESTINATION bin)
ENDIF()
...
IF (ENABLE_XEON_PHI_SUPPORT)
  IF (__HOST__)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi DESTINATION bin)
  ELSE()
    INCLUDE (icc_xeonphi)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi_device DESTINATION bin)
  ENDIF()
ENDIF()
