...
INSTALL(TARGETS ${TUTORIAL_NAME} DESTINATION bin COMPONENT tutorials)
...
IF (ENABLE_ISPC_SUPPORT)
  ...
  INSTALL(TARGETS ${TUTORIAL_NAME}_ispc DESTINATION bin COMPONENT tutorials)
ENDIF()
...
IF (ENABLE_XEON_PHI_SUPPORT)
  ...
  ELSE()
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi_device DESTINATION bin COMPONENT tutorials_xeonphi)
  ENDIF()
ENDIF()
