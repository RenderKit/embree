...
MACRO (ADD_TUTORIAL TUTORIAL_NAME)
  ...
  ADD_EXECUTABLE(${TUTORIAL_NAME} ${TUTORIAL_NAME}.cpp ${TUTORIAL_NAME}_device.cpp ${ARGN})
                                  TARGET_LINK_LIBRARIES(${TUTORIAL_NAME} embree tutorial image transport tutorial_device noise ${ADDITIONAL_LIBRARIES})
  ...
  IF (EMBREE_ISPC_SUPPORT AND EMBREE_RAY_PACKETS)
    ...
    TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_ispc embree tutorial image transport tutorial_device_ispc noise noise_ispc)
