...
INSTALL(TARGETS ${TUTORIAL_NAME} DESTINATION ${RTCORE_INSTALL_BINDIR} COMPONENT examples)

SET(CPACK_NSIS_MENU_LINKS ${CPACK_NSIS_MENU_LINKS} "${RTCORE_INSTALL_BINDIR}/${TUTORIAL_NAME}" "${TUTORIAL_NAME}")
...
IF (ENABLE_ISPC_SUPPORT AND RTCORE_RAY_PACKETS)
  ...
  INSTALL(TARGETS ${TUTORIAL_NAME}_ispc DESTINATION ${RTCORE_INSTALL_BINDIR} COMPONENT examples)
  SET(CPACK_NSIS_MENU_LINKS ${CPACK_NSIS_MENU_LINKS} "${RTCORE_INSTALL_BINDIR}/${TUTORIAL_NAME}_ispc" "${TUTORIAL_NAME}_ispc")
ENDIF()
...
IF (ENABLE_XEON_PHI_SUPPORT)
  IF (__HOST__)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi DESTINATION ${RTCORE_INSTALL_BINDIR} COMPONENT examples_xeonphi)
  ELSE()
    INCLUDE (icc_xeonphi)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi_device DESTINATION ${RTCORE_INSTALL_BINDIR} COMPONENT examples_xeonphi)
  ENDIF()
ENDIF()
