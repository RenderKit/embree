...
MACRO (ADD_TUTORIAL_SYCL TUTORIAL_NAME)
  IF (EMBREE_DPCPP_SUPPORT)
    ADD_EXECUTABLE(${TUTORIAL_NAME}_sycl ${TUTORIAL_NAME}.cpp ${TUTORIAL_NAME}_device.cpp ${ARGN})
    #TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_sycl embree image tutorial_sycl noise ${ADDITIONAL_LIBRARIES})
    TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_sycl embree embree_sycl image tutorial_sycl noise ${ADDITIONAL_LIBRARIES})
    ...
    SET_PROPERTY(TARGET ${TUTORIAL_NAME}_sycl APPEND PROPERTY COMPILE_FLAGS " ${FLAGS_LOWEST} ${CMAKE_CXX_FLAGS_SYCL}")
    SET_PROPERTY(TARGET ${TUTORIAL_NAME}_sycl APPEND PROPERTY LINK_FLAGS "${CMAKE_LINK_FLAGS_SYCL}")
