...
IF (ENABLE_XEON_PHI_SUPPORT)
  IF (__HOST__)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi DESTINATION ${CMAKE_INSTALL_BINDIR} COMPONENT examples_xeonphi)
  ELSE()
    INCLUDE (icc_xeonphi)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi_device DESTINATION ${CMAKE_INSTALL_BINDIR} COMPONENT examples_xeonphi)
  ENDIF()
ENDIF()
