...
INSTALL(TARGETS ${TUTORIAL_NAME} DESTINATION ${TUTORIALS_INSTALL_DIR} COMPONENT tutorials)
...
IF (ENABLE_ISPC_SUPPORT)
  ...
  INSTALL(TARGETS ${TUTORIAL_NAME}_ispc DESTINATION ${TUTORIALS_INSTALL_DIR} COMPONENT tutorials)
ENDIF()
...
IF (ENABLE_XEON_PHI_SUPPORT)
  IF (__HOST__)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi DESTINATION ${TUTORIALS_INSTALL_DIR} COMPONENT tutorials_xeonphi)
  ELSE()
    INCLUDE (icc_xeonphi)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi_device DESTINATION ${TUTORIALS_INSTALL_DIR} COMPONENT tutorials_xeonphi)
  ENDIF()
ENDIF()
