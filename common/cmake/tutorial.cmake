...
INSTALL(TARGETS ${TUTORIAL_NAME} DESTINATION ${BIN_INSTALL_DIR} COMPONENT examples)

SET(CPACK_NSIS_MENU_LINKS ${CPACK_NSIS_MENU_LINKS} "${BIN_INSTALL_DIR}/${TUTORIAL_NAME}" "${TUTORIAL_NAME}")
...
IF (ENABLE_ISPC_SUPPORT AND RTCORE_RAY_PACKETS)
  ...
  INSTALL(TARGETS ${TUTORIAL_NAME}_ispc DESTINATION ${BIN_INSTALL_DIR} COMPONENT examples)
  SET(CPACK_NSIS_MENU_LINKS ${CPACK_NSIS_MENU_LINKS} "${BIN_INSTALL_DIR}/${TUTORIAL_NAME}_ispc" "${TUTORIAL_NAME}_ispc")
ENDIF()
...
IF (ENABLE_XEON_PHI_SUPPORT)
  IF (__HOST__)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi DESTINATION ${BIN_INSTALL_DIR} COMPONENT examples_xeonphi)
  ELSE()
    INCLUDE (icc_xeonphi)
    ...
    INSTALL(TARGETS ${TUTORIAL_NAME}_xeonphi_device DESTINATION ${BIN_INSTALL_DIR} COMPONENT examples_xeonphi)
  ENDIF()
ENDIF()
