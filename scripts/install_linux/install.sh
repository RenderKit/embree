...
cp -r lib/x64/libembree.so.2.3.2 $LIBRARY_INSTALL_DIR
ln -sf $LIBRARY_INSTALL_DIR/libembree.so.2.3.2 $LIBRARY_INSTALL_DIR/libembree.so.2
...
cp -r lib/x64/libembree_xeonphi.so.2.3.2 $LIBRARY_INSTALL_DIR
ln -sf $LIBRARY_INSTALL_DIR/libembree_xeonphi.so.2.3.2 $LIBRARY_INSTALL_DIR/libembree_xeonphi.so.2
