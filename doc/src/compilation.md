...
+ `EMBREE_CURVE_MINWIDTH`: Enabled the min-width feature, which allows increasing
  the radius of curves to match some amount of pixels. See [rtcSetGeometryMaxRadiusScale]
  for more details.
