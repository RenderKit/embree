...
{  
  namespace SceneGraph
  {
    ...
    Ref<Node> createHairyPlane    (int hash, const Vec3fa& pos, const Vec3fa& dx, const Vec3fa& dy, const float len, const float r, size_t numHairs, RTCGeometrySubtype type, Ref<MaterialNode> material = nullptr);
