...
GRL_INLINE void D3D12_set_triangles_IndexFormat(D3D12_RAYTRACING_GEOMETRY_DESC *geomDesc, RTASFile::IndexFormat format)
{
    switch (format)
    {
...
GRL_INLINE RTASFile::IndexFormat D3D12_get_triangles_IndexFormat(D3D12_RAYTRACING_GEOMETRY_DESC *geomDesc)
{
...
{
    d->AccelerationStructure = (char*)address;
}
