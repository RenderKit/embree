...
{  
  ...
  namespace SceneGraph
  {
    ...
    public:
      HairSetNode (RTCCurveType type, RTCCurveBasis basis, Ref<MaterialNode> material, size_t numTimeSteps = 0)
      ...
      HairSetNode (const avector<Vertex>& positions_in, const std::vector<Hair>& hairs, Ref<MaterialNode> material, RTCCurveType type, RTCCurveBasis basis)
    ...
    public:
      RTCCurveType type;                //!< type of geometry (hair or curve)
