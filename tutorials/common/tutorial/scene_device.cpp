...
namespace embree
{
  ...
  std::string to_string(RTCFeatureFlags features)
  {
    ...
    if (features & RTC_FEATURE_FLAGS_FILTER_FUNCTION_IN_CONTEXT) out += "FILTER_FUNCTION_IN_CONTEXT ";
    if (features & RTC_FEATURE_FLAGS_FILTER_FUNCTION_IN_GEOMETRY) out += "FILTER_FUNCTION_IN_GEOMETRY ";
    if (features & RTC_FEATURE_FLAGS_USER_GEOMETRY_CALLBACK_IN_CONTEXT) out += "USER_GEOMETRY_CALLBACK_IN_CONTEXT ";
