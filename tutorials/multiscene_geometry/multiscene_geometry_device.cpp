...
/* add point geometry */
RTCGeometry createPoints (/*RTCScene scene, */RTCGeometryType gtype, const Vec3fa& pos)
{
  RandomSampler rng;
...
RTCGeometry createGroundPlane (/*RTCScene scene_i*/)
{
...
extern "C" void device_init (char* cfg)
{
  ...
  /* add ground plane */
  auto plane = createGroundPlane();
  rtcAttachGeometry(g_scene_0,plane);
  rtcAttachGeometry(g_scene_1,plane);
  rtcAttachGeometry(g_scene_2,plane);
  rtcReleaseGeometry(plane);


  /* add curve */
  auto spheres_0 = createPoints(RTC_GEOMETRY_TYPE_SPHERE_POINT,        Vec3fa( -3.0f, 0.0f, 0.0f));
  auto spheres_1 = createPoints(RTC_GEOMETRY_TYPE_SPHERE_POINT,        Vec3fa( +3.0f, 0.0f, 0.0f));
  //addPoints(g_scene_0, RTC_GEOMETRY_TYPE_DISC_POINT,          Vec3fa( 5.0f, 0.0f, 0.0f));
  //addPoints(g_scene_0, RTC_GEOMETRY_TYPE_ORIENTED_DISC_POINT, Vec3fa(-5.0f, 0.0f, 0.0f));

  rtcAttachGeometry(g_scene_0, spheres_0);
  rtcAttachGeometry(g_scene_1, spheres_1);
  rtcAttachGeometry(g_scene_2, spheres_0);
  rtcAttachGeometry(g_scene_2, spheres_1);

  rtcReleaseGeometry(spheres_0);
  rtcReleaseGeometry(spheres_1);
